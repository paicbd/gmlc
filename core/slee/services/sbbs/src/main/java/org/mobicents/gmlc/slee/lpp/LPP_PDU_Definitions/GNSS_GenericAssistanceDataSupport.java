...
public class GNSS_GenericAssistanceDataSupport extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-GenericAssistanceDataSupport";
   }

   protected GNSS_GenericAssistDataSupportElement[] elements;
    ...
    * populated.
    */
   public GNSS_GenericAssistanceDataSupport (int numRecords) {
      elements = new GNSS_GenericAssistDataSupportElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_GenericAssistanceDataSupport (GNSS_GenericAssistDataSupportElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_GenericAssistanceDataSupport) ) return false;
      GNSS_GenericAssistanceDataSupport rhs = (GNSS_GenericAssistanceDataSupport) obj;
      GNSS_GenericAssistDataSupportElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_GenericAssistDataSupportElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_GenericAssistDataSupportElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_GenericAssistDataSupportElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_GenericAssistDataSupportElement();
