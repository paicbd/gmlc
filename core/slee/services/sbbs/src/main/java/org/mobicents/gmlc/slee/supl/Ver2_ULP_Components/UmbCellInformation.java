...
public class UmbCellInformation extends Asn1Seq {
    ...
    * the given objects 
    */
   public UmbCellInformation (Asn1BitString refSECTORID_,
      long refMCC_,
      long refMNC_,
      long refBASELAT_,
      long reBASELONG_,
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof UmbCellInformation) ) return false;

      UmbCellInformation rhs = (UmbCellInformation) obj;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return refMCC;
         case 2: return refMNC;
         case 3: return refBASELAT;
         case 4: return reBASELONG;
         case 5: return refWeekNumber;
         case 6: return refSeconds;
