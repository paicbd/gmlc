...
public class GNSS_TimeModelList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-TimeModelList";
   }

   protected GNSS_TimeModelElement[] elements;
    ...
    * populated.
    */
   public GNSS_TimeModelList (int numRecords) {
      elements = new GNSS_TimeModelElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_TimeModelList (GNSS_TimeModelElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_TimeModelList) ) return false;
      GNSS_TimeModelList rhs = (GNSS_TimeModelList) obj;
      GNSS_TimeModelElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_TimeModelElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_TimeModelElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_TimeModelElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_TimeModelElement();
