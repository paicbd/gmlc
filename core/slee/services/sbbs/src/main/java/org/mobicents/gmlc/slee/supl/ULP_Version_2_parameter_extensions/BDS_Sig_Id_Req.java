...
public class BDS_Sig_Id_Req extends Asn1BitString {
    ...
    */
   public BDS_Sig_Id_Req (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public BDS_Sig_Id_Req (int numbits_, byte[] data) 
    ...
    */
   public BDS_Sig_Id_Req (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!(getLength() == 8)) {
    ...
    *
    */
   public BDS_Sig_Id_Req (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!(getLength() == 8)) {
    ...
    */
   public BDS_Sig_Id_Req (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!(getLength() == 8)) {
