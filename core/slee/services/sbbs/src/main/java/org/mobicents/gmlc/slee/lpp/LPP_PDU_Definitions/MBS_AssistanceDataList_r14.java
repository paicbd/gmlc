...
public class MBS_AssistanceDataList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBS-AssistanceDataList-r14";
   }

   protected MBS_AssistanceDataElement_r14[] elements;

   public MBS_AssistanceDataList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBS_AssistanceDataList_r14 (int numRecords) {
      elements = new MBS_AssistanceDataElement_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBS_AssistanceDataList_r14 (MBS_AssistanceDataElement_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof MBS_AssistanceDataList_r14) ) return false;
      MBS_AssistanceDataList_r14 rhs = (MBS_AssistanceDataList_r14) obj;
      MBS_AssistanceDataElement_r14[] rhsElements = rhs.elements;
    ...
    */
   public MBS_AssistanceDataElement_r14[] getElements () {
      return elements;
   }
   public void setElements (MBS_AssistanceDataElement_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBS_AssistanceDataElement_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBS_AssistanceDataElement_r14();
