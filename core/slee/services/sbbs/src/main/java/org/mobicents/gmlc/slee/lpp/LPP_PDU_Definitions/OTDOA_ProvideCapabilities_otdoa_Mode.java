...
public class OTDOA_ProvideCapabilities_otdoa_Mode extends Asn1BitString {
   ...
   public final static int ue_assisted = 0;
   public final static int ue_assisted_NB_r14 = 1;
   public final static int ue_assisted_NB_TDD_r15 = 2;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode (int numbits_, byte[] data) 
    ...
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public OTDOA_ProvideCapabilities_otdoa_Mode (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
