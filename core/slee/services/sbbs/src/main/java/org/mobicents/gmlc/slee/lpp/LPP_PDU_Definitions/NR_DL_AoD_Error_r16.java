...
public class NR_DL_AoD_Error_r16 extends Asn1Choice {
   ...
   public NR_DL_AoD_Error_r16 () {
      super();
   }

   public NR_DL_AoD_Error_r16 (byte choiceId_, Asn1Type element_) {
      super();
    ...
    */
   public NR_DL_AoD_LocationServerErrorCauses_r16 getLocationServerErrorCauses_r16 () {
      return (choiceID == _LOCATIONSERVERERRORCAUSES_R16) ? (NR_DL_AoD_LocationServerErrorCauses_r16)element : null;
   }
   public void setLocationServerErrorCauses_r16 (NR_DL_AoD_LocationServerErrorCauses_r16 value) {
    ...
    */
   public NR_DL_AoD_TargetDeviceErrorCauses_r16 getTargetDeviceErrorCauses_r16 () {
      return (choiceID == _TARGETDEVICEERRORCAUSES_R16) ? (NR_DL_AoD_TargetDeviceErrorCauses_r16)element : null;
   }
   public void setTargetDeviceErrorCauses_r16 (NR_DL_AoD_TargetDeviceErrorCauses_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (idx) {
            ...
            case 0: { 
               NR_DL_AoD_LocationServerErrorCauses_r16 locationServerErrorCauses_r16;
               element = locationServerErrorCauses_r16 = new NR_DL_AoD_LocationServerErrorCauses_r16();
            ...
            case 1: { 
               NR_DL_AoD_TargetDeviceErrorCauses_r16 targetDeviceErrorCauses_r16;
               element = targetDeviceErrorCauses_r16 = new NR_DL_AoD_TargetDeviceErrorCauses_r16();
      ...
      if (!extbit) {
         ...
         switch (choiceID) {
            ...
            case _LOCATIONSERVERERRORCAUSES_R16:
               NR_DL_AoD_LocationServerErrorCauses_r16 locationServerErrorCauses_r16 = (NR_DL_AoD_LocationServerErrorCauses_r16) element;
               locationServerErrorCauses_r16.encode (buffer);
               break;

            // targetDeviceErrorCauses_r16
            case _TARGETDEVICEERRORCAUSES_R16:
               NR_DL_AoD_TargetDeviceErrorCauses_r16 targetDeviceErrorCauses_r16 = (NR_DL_AoD_TargetDeviceErrorCauses_r16) element;
