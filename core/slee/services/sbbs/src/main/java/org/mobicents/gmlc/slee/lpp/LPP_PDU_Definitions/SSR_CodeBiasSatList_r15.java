...
public class SSR_CodeBiasSatList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSR-CodeBiasSatList-r15";
   }

   protected SSR_CodeBiasSatElement_r15[] elements;

   public SSR_CodeBiasSatList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSR_CodeBiasSatList_r15 (int numRecords) {
      elements = new SSR_CodeBiasSatElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSR_CodeBiasSatList_r15 (SSR_CodeBiasSatElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SSR_CodeBiasSatList_r15) ) return false;
      SSR_CodeBiasSatList_r15 rhs = (SSR_CodeBiasSatList_r15) obj;
      SSR_CodeBiasSatElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public SSR_CodeBiasSatElement_r15[] getElements () {
      return elements;
   }
   public void setElements (SSR_CodeBiasSatElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSR_CodeBiasSatElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSR_CodeBiasSatElement_r15();
