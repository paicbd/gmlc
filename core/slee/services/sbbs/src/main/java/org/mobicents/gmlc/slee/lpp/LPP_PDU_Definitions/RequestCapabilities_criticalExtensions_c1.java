...
public class RequestCapabilities_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _REQUESTCAPABILITIES_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public RequestCapabilities_criticalExtensions_c1 () {
      super();
   }

   public RequestCapabilities_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _REQUESTCAPABILITIES_R9: return "requestCapabilities_r9";
   ...
   /**
    * Accessor/mutator methods for requestCapabilities_r9
    */
   public RequestCapabilities_r9_IEs getRequestCapabilities_r9 () {
      return (choiceID == _REQUESTCAPABILITIES_R9) ? (RequestCapabilities_r9_IEs)element : null;
   }
   public void setRequestCapabilities_r9 (RequestCapabilities_r9_IEs value) {
      setElement (_REQUESTCAPABILITIES_R9, value);
   }
   public boolean isRequestCapabilities_r9 () {
      return (choiceID == _REQUESTCAPABILITIES_R9);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // requestCapabilities_r9
         case 0: { 
            RequestCapabilities_r9_IEs requestCapabilities_r9;
            element = requestCapabilities_r9 = new RequestCapabilities_r9_IEs();
            requestCapabilities_r9.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // requestCapabilities_r9
         case _REQUESTCAPABILITIES_R9:
            RequestCapabilities_r9_IEs requestCapabilities_r9 = (RequestCapabilities_r9_IEs) element;
            requestCapabilities_r9.encode (buffer);
            break;
