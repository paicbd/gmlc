...
public class WCDMAAreaId extends Asn1Seq {
   ...
   protected Asn1Integer refUC;  // optional
    ...
    * the given objects 
    */
   public WCDMAAreaId (long refMCC_,
      long refMNC_,
      long refLAC_,
      long refUC_
   ) throws Asn1Exception {
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof WCDMAAreaId) ) return false;

      WCDMAAreaId rhs = (WCDMAAreaId) obj;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean refUCPresent = buffer.decodeBit ("refUCPresent");
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((refUC != null), null);
