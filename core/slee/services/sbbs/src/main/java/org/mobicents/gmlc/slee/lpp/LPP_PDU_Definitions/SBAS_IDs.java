...
public class SBAS_IDs extends Asn1Seq {
   ...
   protected SBAS_IDs_sbas_IDs sbas_IDs;
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SBAS_IDs) ) return false;

      SBAS_IDs rhs = (SBAS_IDs) obj;
    ...
    */
   public SBAS_IDs_sbas_IDs getSbas_IDs () {
      return sbas_IDs;
   }

   public void setSbas_IDs (SBAS_IDs_sbas_IDs value) 
      throws Asn1Exception
   {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      sbas_IDs = new SBAS_IDs_sbas_IDs();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      else throw new Asn1MissingRequiredException ("sbas_IDs");
