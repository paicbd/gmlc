...
public class EllipsoidPointWithAltitudeAndUncertaintyEllipsoid extends Asn1Seq {
   ...
   protected EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_latitudeSign latitudeSign = null;
   protected Asn1Integer degreesLatitude;
   protected Asn1Integer degreesLongitude;
   protected EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_altitudeDirection altitudeDirection = null;
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof EllipsoidPointWithAltitudeAndUncertaintyEllipsoid) ) return false;

      EllipsoidPointWithAltitudeAndUncertaintyEllipsoid rhs = (EllipsoidPointWithAltitudeAndUncertaintyEllipsoid) obj;
    ...
    */
   public EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_latitudeSign getLatitudeSign () {
      return latitudeSign;
   }

   public void setLatitudeSign (EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_latitudeSign value) {
    ...
    */
   public EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_altitudeDirection getAltitudeDirection () {
      return altitudeDirection;
   }

   public void setAltitudeDirection (EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_altitudeDirection value) {
