...
public class BT_MeasurementList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BT-MeasurementList-r13";
   }

   protected BT_MeasurementElement_r13[] elements;
    ...
    * populated.
    */
   public BT_MeasurementList_r13 (int numRecords) {
      elements = new BT_MeasurementElement_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public BT_MeasurementList_r13 (BT_MeasurementElement_r13[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof BT_MeasurementList_r13) ) return false;
      BT_MeasurementList_r13 rhs = (BT_MeasurementList_r13) obj;
      BT_MeasurementElement_r13[] rhsElements = rhs.elements;
    ...
    */
   public BT_MeasurementElement_r13[] getElements () {
      return elements;
   }
   public void setElements (BT_MeasurementElement_r13[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BT_MeasurementElement_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BT_MeasurementElement_r13();
