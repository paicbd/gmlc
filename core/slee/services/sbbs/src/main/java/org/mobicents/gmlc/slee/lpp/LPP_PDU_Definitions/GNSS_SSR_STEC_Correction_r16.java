...
public class GNSS_SSR_STEC_Correction_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-SSR-STEC-Correction-r16";
   }
   ...
   protected STEC_SatList_r16 stec_SatList_r16;
   protected Asn1OpenExt extElem1;

   public GNSS_SSR_STEC_Correction_r16 () {
      super();
      init();
   }
   ...
   public GNSS_SSR_STEC_Correction_r16 (
      ...
      STEC_SatList_r16 stec_SatList_r16_
      ...
      setStec_SatList_r16 (stec_SatList_r16_);
   }
    ...
    * the given objects 
    */
   public GNSS_SSR_STEC_Correction_r16 (GNSS_SystemTime epochTime_r16_,
   ...
   public void init () {
      ...
      stec_SatList_r16 = null;
      extElem1 = null;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof GNSS_SSR_STEC_Correction_r16) ) return false;

      GNSS_SSR_STEC_Correction_r16 rhs = (GNSS_SSR_STEC_Correction_r16) obj;
      ...
      if (stec_SatList_r16 == null) {
         if (rhs.stec_SatList_r16 != null) return false;
      }
      else {
         if (!stec_SatList_r16.equals(rhs.stec_SatList_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (stec_SatList_r16 != null) __code = 31*__code + stec_SatList_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for Stec_SatList_r16
    */
   public STEC_SatList_r16 getStec_SatList_r16 () {
      return stec_SatList_r16;
   }

   public void setStec_SatList_r16 (STEC_SatList_r16 value) 
      throws Asn1Exception
   {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 3: return correctionPointSetID_r16;
         case 4: return stec_SatList_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 3: return "correctionPointSetID-r16";
         case 4: return "stec-SatList-r16";
         case 5: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // decode stec_SatList_r16

      buffer.getContext().eventDispatcher.startElement("stec_SatList_r16", -1);

      stec_SatList_r16 = new STEC_SatList_r16();
      stec_SatList_r16.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("stec_SatList_r16", -1);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode stec_SatList_r16

      if (stec_SatList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("stec_SatList_r16", -1);

         stec_SatList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("stec_SatList_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("stec_SatList_r16");
