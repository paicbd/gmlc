...
public class OTDOA_ReferenceCellInfo_addPRSconfigRef_r14 extends Asn1SeqOf {
   ...
   protected PRS_Info[] elements;

   public OTDOA_ReferenceCellInfo_addPRSconfigRef_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOA_ReferenceCellInfo_addPRSconfigRef_r14 (int numRecords) {
      elements = new PRS_Info [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOA_ReferenceCellInfo_addPRSconfigRef_r14 (PRS_Info[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_ReferenceCellInfo_addPRSconfigRef_r14) ) return false;
      OTDOA_ReferenceCellInfo_addPRSconfigRef_r14 rhs = (OTDOA_ReferenceCellInfo_addPRSconfigRef_r14) obj;
      PRS_Info[] rhsElements = rhs.elements;
    ...
    */
   public PRS_Info[] getElements () {
      return elements;
   }
   public void setElements (PRS_Info[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PRS_Info [numElements];
