...
public class TimeslotISCP_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TimeslotISCP-List";
   }

   protected TimeslotISCP[] elements;
    ...
    * populated.
    */
   public TimeslotISCP_List (int numRecords) {
      elements = new TimeslotISCP [numRecords];
   }
    ...
    * given the array.  
    */
   public TimeslotISCP_List (TimeslotISCP[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof TimeslotISCP_List) ) return false;
      TimeslotISCP_List rhs = (TimeslotISCP_List) obj;
      TimeslotISCP[] rhsElements = rhs.elements;
    ...
    */
   public TimeslotISCP[] getElements () {
      return elements;
   }
   public void setElements (TimeslotISCP[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TimeslotISCP [numElements];
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 14);
