...
public class Abort extends Asn1Seq {
   ...
   protected Abort_criticalExtensions criticalExtensions;
    ...
    */
   public Abort (
      Abort_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof Abort) ) return false;
    ...
    */
   public Abort_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (Abort_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new Abort_criticalExtensions();
