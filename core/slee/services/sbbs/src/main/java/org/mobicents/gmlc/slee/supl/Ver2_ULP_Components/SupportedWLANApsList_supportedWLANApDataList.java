...
public class SupportedWLANApsList_supportedWLANApDataList extends Asn1SeqOf {
   ...
   protected SupportedWLANApData[] elements;

   public SupportedWLANApsList_supportedWLANApDataList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedWLANApsList_supportedWLANApDataList (int numRecords) {
      elements = new SupportedWLANApData [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedWLANApsList_supportedWLANApDataList (SupportedWLANApData[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SupportedWLANApsList_supportedWLANApDataList) ) return false;
      SupportedWLANApsList_supportedWLANApDataList rhs = (SupportedWLANApsList_supportedWLANApDataList) obj;
      SupportedWLANApData[] rhsElements = rhs.elements;
    ...
    */
   public SupportedWLANApData[] getElements () {
      return elements;
   }
   public void setElements (SupportedWLANApData[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedWLANApData [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedWLANApData();
