...
public class GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16 extends Asn1SeqOf {
   ...
   protected RelativeLocationElement_r16[] elements;

   public GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16 (int numRecords) {
      elements = new RelativeLocationElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16 (RelativeLocationElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16) ) return false;
      GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16 rhs = (GNSS_SSR_ListOfCorrectionPoints_r16_relativeLocationsList_r16) obj;
      RelativeLocationElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public RelativeLocationElement_r16[] getElements () {
      return elements;
   }
   public void setElements (RelativeLocationElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 63);
      int numElements = (int) buffer.decodeLength();

      elements = new RelativeLocationElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RelativeLocationElement_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 0, 63);
