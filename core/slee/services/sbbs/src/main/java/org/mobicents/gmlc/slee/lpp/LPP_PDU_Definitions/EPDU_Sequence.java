...
public class EPDU_Sequence extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EPDU-Sequence";
   }

   protected EPDU[] elements;
    ...
    * populated.
    */
   public EPDU_Sequence (int numRecords) {
      elements = new EPDU [numRecords];
   }
    ...
    * given the array.  
    */
   public EPDU_Sequence (EPDU[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof EPDU_Sequence) ) return false;
      EPDU_Sequence rhs = (EPDU_Sequence) obj;
      EPDU[] rhsElements = rhs.elements;
    ...
    */
   public EPDU[] getElements () {
      return elements;
   }
   public void setElements (EPDU[] value) {
      elements = value;
   }
