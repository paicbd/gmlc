...
public class WLAN_RequestAssistanceData_r14_requestedAD_r14 extends Asn1BitString {
    ...
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 (int numbits_, byte[] data) 
    ...
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public WLAN_RequestAssistanceData_r14_requestedAD_r14 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
