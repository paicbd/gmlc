...
public class MeasuredResultsList extends Asn1SeqOf {
   ...
   protected MeasuredResultsElement[] elements;
    ...
    * populated.
    */
   public MeasuredResultsList (int numRecords) {
      elements = new MeasuredResultsElement [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasuredResultsList (MeasuredResultsElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof MeasuredResultsList) ) return false;
      MeasuredResultsList rhs = (MeasuredResultsList) obj;
      MeasuredResultsElement[] rhsElements = rhs.elements;
    ...
    */
   public MeasuredResultsElement[] getElements () {
      return elements;
   }
   public void setElements (MeasuredResultsElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasuredResultsElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasuredResultsElement();
