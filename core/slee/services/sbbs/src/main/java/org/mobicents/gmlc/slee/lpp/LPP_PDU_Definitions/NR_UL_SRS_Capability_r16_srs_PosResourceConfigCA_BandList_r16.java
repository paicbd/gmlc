...
public class NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16 extends Asn1SeqOf {
   ...
   protected SRS_PosResourcesPerBand_r16[] elements;

   public NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16 (int numRecords) {
      elements = new SRS_PosResourcesPerBand_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16 (SRS_PosResourcesPerBand_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16) ) return false;
      NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16 rhs = (NR_UL_SRS_Capability_r16_srs_PosResourceConfigCA_BandList_r16) obj;
      SRS_PosResourcesPerBand_r16[] rhsElements = rhs.elements;
    ...
    */
   public SRS_PosResourcesPerBand_r16[] getElements () {
      return elements;
   }
   public void setElements (SRS_PosResourcesPerBand_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_PosResourcesPerBand_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_PosResourcesPerBand_r16();
