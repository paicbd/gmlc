...
public class GridIonList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GridIonList-r12";
   }

   protected GridIonElement_r12[] elements;
    ...
    * populated.
    */
   public GridIonList_r12 (int numRecords) {
      elements = new GridIonElement_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public GridIonList_r12 (GridIonElement_r12[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GridIonList_r12) ) return false;
      GridIonList_r12 rhs = (GridIonList_r12) obj;
      GridIonElement_r12[] rhsElements = rhs.elements;
    ...
    */
   public GridIonElement_r12[] getElements () {
      return elements;
   }
   public void setElements (GridIonElement_r12[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GridIonElement_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GridIonElement_r12();
