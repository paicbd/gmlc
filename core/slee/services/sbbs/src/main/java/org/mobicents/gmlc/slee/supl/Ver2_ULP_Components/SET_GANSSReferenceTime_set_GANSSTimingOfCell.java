...
public class SET_GANSSReferenceTime_set_GANSSTimingOfCell extends Asn1Seq {
   ...
   public SET_GANSSReferenceTime_set_GANSSTimingOfCell () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SET_GANSSReferenceTime_set_GANSSTimingOfCell (long ms_part_,
      long ls_part_
   ) throws Asn1Exception {
      super();
      setMs_part (ms_part_);
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SET_GANSSReferenceTime_set_GANSSTimingOfCell) ) return false;

      SET_GANSSReferenceTime_set_GANSSTimingOfCell rhs = (SET_GANSSReferenceTime_set_GANSSTimingOfCell) obj;
   ...
   public void setMs_part (Asn1Integer value) 
      throws Asn1Exception
   {
      if (!((value.value >= 0 && value.value <= 80))) {
