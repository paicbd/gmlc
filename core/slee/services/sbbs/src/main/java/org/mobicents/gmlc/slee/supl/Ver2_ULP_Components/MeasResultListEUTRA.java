...
public class MeasResultListEUTRA extends Asn1SeqOf {
   ...
   protected MeasResultEUTRA[] elements;
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof MeasResultListEUTRA) ) return false;
      MeasResultListEUTRA rhs = (MeasResultListEUTRA) obj;
      MeasResultEUTRA[] rhsElements = rhs.elements;
    ...
    */
   public MeasResultEUTRA[] getElements () {
      return elements;
   }
   public void setElements (MeasResultEUTRA[] value) {
      elements = value;
   }
