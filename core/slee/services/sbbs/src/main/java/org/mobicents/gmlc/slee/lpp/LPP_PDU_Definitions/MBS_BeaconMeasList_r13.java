...
public class MBS_BeaconMeasList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBS-BeaconMeasList-r13";
   }

   protected MBS_BeaconMeasElement_r13[] elements;
    ...
    * populated.
    */
   public MBS_BeaconMeasList_r13 (int numRecords) {
      elements = new MBS_BeaconMeasElement_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBS_BeaconMeasList_r13 (MBS_BeaconMeasElement_r13[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof MBS_BeaconMeasList_r13) ) return false;
      MBS_BeaconMeasList_r13 rhs = (MBS_BeaconMeasList_r13) obj;
      MBS_BeaconMeasElement_r13[] rhsElements = rhs.elements;
    ...
    */
   public MBS_BeaconMeasElement_r13[] getElements () {
      return elements;
   }
   public void setElements (MBS_BeaconMeasElement_r13[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBS_BeaconMeasElement_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBS_BeaconMeasElement_r13();
