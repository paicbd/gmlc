...
public class KeyIdentity extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public KeyIdentity (int numbits_, byte[] data) 
    ...
    */
   public KeyIdentity (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!(getLength() == 128)) {
    ...
    *
    */
   public KeyIdentity (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!(getLength() == 128)) {
    ...
    */
   public KeyIdentity (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!(getLength() == 128)) {
