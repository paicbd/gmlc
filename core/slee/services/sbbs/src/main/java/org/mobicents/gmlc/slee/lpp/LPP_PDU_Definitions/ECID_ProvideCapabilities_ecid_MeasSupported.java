...
public class ECID_ProvideCapabilities_ecid_MeasSupported extends Asn1BitString {
   ...
   public final static int rsrpSup = 0;
   public final static int rsrqSup = 1;
   public final static int ueRxTxSup = 2;
   public final static int nrsrpSup_r14 = 3;
   public final static int nrsrqSup_r14 = 4;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported (int numbits_, byte[] data) 
    ...
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public ECID_ProvideCapabilities_ecid_MeasSupported (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
