...
public class GNSS_TimeModelListReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-TimeModelListReq";
   }

   protected GNSS_TimeModelElementReq[] elements;
    ...
    * populated.
    */
   public GNSS_TimeModelListReq (int numRecords) {
      elements = new GNSS_TimeModelElementReq [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_TimeModelListReq (GNSS_TimeModelElementReq[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_TimeModelListReq) ) return false;
      GNSS_TimeModelListReq rhs = (GNSS_TimeModelListReq) obj;
      GNSS_TimeModelElementReq[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_TimeModelElementReq[] getElements () {
      return elements;
   }
   public void setElements (GNSS_TimeModelElementReq[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_TimeModelElementReq [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_TimeModelElementReq();
