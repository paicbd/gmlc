...
public class AuxiliaryStationList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AuxiliaryStationList-r15";
   }

   protected AuxiliaryStationElement_r15[] elements;

   public AuxiliaryStationList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AuxiliaryStationList_r15 (int numRecords) {
      elements = new AuxiliaryStationElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public AuxiliaryStationList_r15 (AuxiliaryStationElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AuxiliaryStationList_r15) ) return false;
      AuxiliaryStationList_r15 rhs = (AuxiliaryStationList_r15) obj;
      AuxiliaryStationElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public AuxiliaryStationElement_r15[] getElements () {
      return elements;
   }
   public void setElements (AuxiliaryStationElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AuxiliaryStationElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AuxiliaryStationElement_r15();
