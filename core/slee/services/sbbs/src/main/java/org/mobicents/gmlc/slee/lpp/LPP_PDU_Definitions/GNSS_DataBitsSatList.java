...
public class GNSS_DataBitsSatList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-DataBitsSatList";
   }

   protected GNSS_DataBitsSatElement[] elements;
    ...
    * populated.
    */
   public GNSS_DataBitsSatList (int numRecords) {
      elements = new GNSS_DataBitsSatElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_DataBitsSatList (GNSS_DataBitsSatElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_DataBitsSatList) ) return false;
      GNSS_DataBitsSatList rhs = (GNSS_DataBitsSatList) obj;
      GNSS_DataBitsSatElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_DataBitsSatElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_DataBitsSatElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_DataBitsSatElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_DataBitsSatElement();
