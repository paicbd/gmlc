...
public class GNSS_GenericAssistDataReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-GenericAssistDataReq";
   }

   protected GNSS_GenericAssistDataReqElement[] elements;
    ...
    * populated.
    */
   public GNSS_GenericAssistDataReq (int numRecords) {
      elements = new GNSS_GenericAssistDataReqElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_GenericAssistDataReq (GNSS_GenericAssistDataReqElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_GenericAssistDataReq) ) return false;
      GNSS_GenericAssistDataReq rhs = (GNSS_GenericAssistDataReq) obj;
      GNSS_GenericAssistDataReqElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_GenericAssistDataReqElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_GenericAssistDataReqElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_GenericAssistDataReqElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_GenericAssistDataReqElement();
