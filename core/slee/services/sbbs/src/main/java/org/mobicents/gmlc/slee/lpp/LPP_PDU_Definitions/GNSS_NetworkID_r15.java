...
public class GNSS_NetworkID_r15 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-NetworkID-r15";
   }

   protected Asn1Integer networkID_r15;
   protected Asn1OpenExt extElem1;

   public GNSS_NetworkID_r15 () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public GNSS_NetworkID_r15 (long networkID_r15_
   ) throws Asn1Exception {
      super();
      setNetworkID_r15 (networkID_r15_);
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_NetworkID_r15) ) return false;

      GNSS_NetworkID_r15 rhs = (GNSS_NetworkID_r15) obj;
    ...
    */
   public Asn1Integer getNetworkID_r15 () {
      return networkID_r15;
   }

   public void setNetworkID_r15 (Asn1Integer value) 
      throws Asn1Exception
   {
   ...
   public void setNetworkID_r15 (long value) 
      throws Asn1Exception
   {
      setNetworkID_r15 (new Asn1Integer(value));
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      networkID_r15 = new Asn1Integer();
      networkID_r15.decode (buffer, 0, 255);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (networkID_r15 != null) {
         ...
         networkID_r15.encode (buffer, 0, 255);
