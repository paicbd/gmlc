...
public class NR_Multi_RTT_AdditionalMeasurements_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NR-Multi-RTT-AdditionalMeasurements-r16";
   }

   protected NR_Multi_RTT_AdditionalMeasurementElement_r16[] elements;

   public NR_Multi_RTT_AdditionalMeasurements_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_Multi_RTT_AdditionalMeasurements_r16 (int numRecords) {
      elements = new NR_Multi_RTT_AdditionalMeasurementElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_Multi_RTT_AdditionalMeasurements_r16 (NR_Multi_RTT_AdditionalMeasurementElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_Multi_RTT_AdditionalMeasurements_r16) ) return false;
      NR_Multi_RTT_AdditionalMeasurements_r16 rhs = (NR_Multi_RTT_AdditionalMeasurements_r16) obj;
      NR_Multi_RTT_AdditionalMeasurementElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public NR_Multi_RTT_AdditionalMeasurementElement_r16[] getElements () {
      return elements;
   }
   public void setElements (NR_Multi_RTT_AdditionalMeasurementElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_Multi_RTT_AdditionalMeasurementElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_Multi_RTT_AdditionalMeasurementElement_r16();
