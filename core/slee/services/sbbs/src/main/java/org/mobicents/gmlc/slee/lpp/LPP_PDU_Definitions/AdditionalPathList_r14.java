...
public class AdditionalPathList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AdditionalPathList-r14";
   }

   protected AdditionalPath_r14[] elements;

   public AdditionalPathList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalPathList_r14 (int numRecords) {
      elements = new AdditionalPath_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public AdditionalPathList_r14 (AdditionalPath_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AdditionalPathList_r14) ) return false;
      AdditionalPathList_r14 rhs = (AdditionalPathList_r14) obj;
      AdditionalPath_r14[] rhsElements = rhs.elements;
    ...
    */
   public AdditionalPath_r14[] getElements () {
      return elements;
   }
   public void setElements (AdditionalPath_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AdditionalPath_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AdditionalPath_r14();
