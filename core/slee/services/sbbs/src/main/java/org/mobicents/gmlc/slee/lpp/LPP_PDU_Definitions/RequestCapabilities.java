...
public class RequestCapabilities extends Asn1Seq {
   ...
   protected RequestCapabilities_criticalExtensions criticalExtensions;
    ...
    */
   public RequestCapabilities (
      RequestCapabilities_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RequestCapabilities) ) return false;

      RequestCapabilities rhs = (RequestCapabilities) obj;
    ...
    */
   public RequestCapabilities_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (RequestCapabilities_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RequestCapabilities_criticalExtensions();
