...
public class SBAS_IDs_sbas_IDs extends Asn1BitString {
   ...
   public final static int waas = 0;
   public final static int egnos = 1;
   public final static int msas = 2;
   public final static int gagan = 3;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public SBAS_IDs_sbas_IDs () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public SBAS_IDs_sbas_IDs (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SBAS_IDs_sbas_IDs (int numbits_, byte[] data) 
    ...
    */
   public SBAS_IDs_sbas_IDs (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public SBAS_IDs_sbas_IDs (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public SBAS_IDs_sbas_IDs (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
