...
public class DGNSS_SgnTypeList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DGNSS-SgnTypeList";
   }

   protected DGNSS_SgnTypeElement[] elements;
    ...
    * populated.
    */
   public DGNSS_SgnTypeList (int numRecords) {
      elements = new DGNSS_SgnTypeElement [numRecords];
   }
    ...
    * given the array.  
    */
   public DGNSS_SgnTypeList (DGNSS_SgnTypeElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof DGNSS_SgnTypeList) ) return false;
      DGNSS_SgnTypeList rhs = (DGNSS_SgnTypeList) obj;
      DGNSS_SgnTypeElement[] rhsElements = rhs.elements;
    ...
    */
   public DGNSS_SgnTypeElement[] getElements () {
      return elements;
   }
   public void setElements (DGNSS_SgnTypeElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DGNSS_SgnTypeElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DGNSS_SgnTypeElement();
