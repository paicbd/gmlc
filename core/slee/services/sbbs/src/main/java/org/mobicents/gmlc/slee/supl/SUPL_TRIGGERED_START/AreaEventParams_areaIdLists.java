...
public class AreaEventParams_areaIdLists extends Asn1SeqOf {
    ...
    * populated.
    */
   public AreaEventParams_areaIdLists (int numRecords) {
      elements = new AreaIdList [numRecords];
   }
    ...
    * given the array.  
    */
   public AreaEventParams_areaIdLists (AreaIdList[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AreaEventParams_areaIdLists) ) return false;
      AreaEventParams_areaIdLists rhs = (AreaEventParams_areaIdLists) obj;
      AreaIdList[] rhsElements = rhs.elements;
    ...
    */
   public AreaIdList[] getElements () {
      return elements;
   }
   public void setElements (AreaIdList[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AreaIdList [numElements];
