...
public class GNSS_NavListInfo_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-NavListInfo-r15";
   }

   protected SatListElement_r15[] elements;

   public GNSS_NavListInfo_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNSS_NavListInfo_r15 (int numRecords) {
      elements = new SatListElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_NavListInfo_r15 (SatListElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_NavListInfo_r15) ) return false;
      GNSS_NavListInfo_r15 rhs = (GNSS_NavListInfo_r15) obj;
      SatListElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public SatListElement_r15[] getElements () {
      return elements;
   }
   public void setElements (SatListElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SatListElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SatListElement_r15();
