...
public class GNSS_ObservationList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-ObservationList-r15";
   }

   protected GNSS_RTK_SatelliteDataElement_r15[] elements;

   public GNSS_ObservationList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNSS_ObservationList_r15 (int numRecords) {
      elements = new GNSS_RTK_SatelliteDataElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_ObservationList_r15 (GNSS_RTK_SatelliteDataElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_ObservationList_r15) ) return false;
      GNSS_ObservationList_r15 rhs = (GNSS_ObservationList_r15) obj;
      GNSS_RTK_SatelliteDataElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_RTK_SatelliteDataElement_r15[] getElements () {
      return elements;
   }
   public void setElements (GNSS_RTK_SatelliteDataElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_RTK_SatelliteDataElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_RTK_SatelliteDataElement_r15();
