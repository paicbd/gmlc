...
public class ECGI_mnc extends Asn1SeqOf {
    ...
    * populated.
    */
   public ECGI_mnc (int numRecords) {
    ...
    * given the array.  
    */
   public ECGI_mnc (Asn1Integer[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ECGI_mnc) ) return false;
      ECGI_mnc rhs = (ECGI_mnc) obj;
