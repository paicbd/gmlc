...
public class ProvideCapabilities_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _PROVIDECAPABILITIES_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ProvideCapabilities_criticalExtensions_c1 () {
      super();
   }

   public ProvideCapabilities_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _PROVIDECAPABILITIES_R9: return "provideCapabilities_r9";
   ...
   /**
    * Accessor/mutator methods for provideCapabilities_r9
    */
   public ProvideCapabilities_r9_IEs getProvideCapabilities_r9 () {
      return (choiceID == _PROVIDECAPABILITIES_R9) ? (ProvideCapabilities_r9_IEs)element : null;
   }
   public void setProvideCapabilities_r9 (ProvideCapabilities_r9_IEs value) {
      setElement (_PROVIDECAPABILITIES_R9, value);
   }
   public boolean isProvideCapabilities_r9 () {
      return (choiceID == _PROVIDECAPABILITIES_R9);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = provideCapabilities_r9 = new ProvideCapabilities_r9_IEs();
            provideCapabilities_r9.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // provideCapabilities_r9
         case _PROVIDECAPABILITIES_R9:
            ProvideCapabilities_r9_IEs provideCapabilities_r9 = (ProvideCapabilities_r9_IEs) element;
            provideCapabilities_r9.encode (buffer);
            break;
