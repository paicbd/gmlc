...
public class GeographicTargetAreaList extends Asn1SeqOf {
   ...
   protected GeographicTargetArea[] elements;
    ...
    * populated.
    */
   public GeographicTargetAreaList (int numRecords) {
      elements = new GeographicTargetArea [numRecords];
   }
    ...
    * given the array.  
    */
   public GeographicTargetAreaList (GeographicTargetArea[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GeographicTargetAreaList) ) return false;
      GeographicTargetAreaList rhs = (GeographicTargetAreaList) obj;
      GeographicTargetArea[] rhsElements = rhs.elements;
    ...
    */
   public GeographicTargetArea[] getElements () {
      return elements;
   }
   public void setElements (GeographicTargetArea[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GeographicTargetArea [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GeographicTargetArea();
