...
public class RTK_CorrectionDifferencesList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RTK-CorrectionDifferencesList-r15";
   }

   protected RTK_CorrectionDifferencesElement_r15[] elements;

   public RTK_CorrectionDifferencesList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RTK_CorrectionDifferencesList_r15 (int numRecords) {
      elements = new RTK_CorrectionDifferencesElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public RTK_CorrectionDifferencesList_r15 (RTK_CorrectionDifferencesElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RTK_CorrectionDifferencesList_r15) ) return false;
      RTK_CorrectionDifferencesList_r15 rhs = (RTK_CorrectionDifferencesList_r15) obj;
      RTK_CorrectionDifferencesElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public RTK_CorrectionDifferencesElement_r15[] getElements () {
      return elements;
   }
   public void setElements (RTK_CorrectionDifferencesElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RTK_CorrectionDifferencesElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RTK_CorrectionDifferencesElement_r15();
