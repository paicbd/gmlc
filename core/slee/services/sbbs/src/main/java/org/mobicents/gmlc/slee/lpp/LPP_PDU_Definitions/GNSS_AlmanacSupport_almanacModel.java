...
public class GNSS_AlmanacSupport_almanacModel extends Asn1BitString {
    ...
    */
   public GNSS_AlmanacSupport_almanacModel (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public GNSS_AlmanacSupport_almanacModel (int numbits_, byte[] data) 
    ...
    */
   public GNSS_AlmanacSupport_almanacModel (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public GNSS_AlmanacSupport_almanacModel (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public GNSS_AlmanacSupport_almanacModel (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
