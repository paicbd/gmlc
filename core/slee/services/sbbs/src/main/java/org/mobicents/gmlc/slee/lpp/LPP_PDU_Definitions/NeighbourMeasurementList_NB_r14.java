...
public class NeighbourMeasurementList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighbourMeasurementList-NB-r14";
   }

   protected NeighbourMeasurementElement_NB_r14[] elements;

   public NeighbourMeasurementList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighbourMeasurementList_NB_r14 (int numRecords) {
      elements = new NeighbourMeasurementElement_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighbourMeasurementList_NB_r14 (NeighbourMeasurementElement_NB_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NeighbourMeasurementList_NB_r14) ) return false;
      NeighbourMeasurementList_NB_r14 rhs = (NeighbourMeasurementList_NB_r14) obj;
      NeighbourMeasurementElement_NB_r14[] rhsElements = rhs.elements;
    ...
    */
   public NeighbourMeasurementElement_NB_r14[] getElements () {
      return elements;
   }
   public void setElements (NeighbourMeasurementElement_NB_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighbourMeasurementElement_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighbourMeasurementElement_NB_r14();
