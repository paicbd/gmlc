...
public class SSB_IndexList_Measurements extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSB-IndexList-Measurements";
   }

   protected SSB_Index_Measurements[] elements;

   public SSB_IndexList_Measurements () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSB_IndexList_Measurements (int numRecords) {
      elements = new SSB_Index_Measurements [numRecords];
   }
    ...
    * given the array.  
    */
   public SSB_IndexList_Measurements (SSB_Index_Measurements[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SSB_IndexList_Measurements) ) return false;
      SSB_IndexList_Measurements rhs = (SSB_IndexList_Measurements) obj;
      SSB_Index_Measurements[] rhsElements = rhs.elements;
    ...
    */
   public SSB_Index_Measurements[] getElements () {
      return elements;
   }
   public void setElements (SSB_Index_Measurements[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSB_Index_Measurements [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSB_Index_Measurements();
