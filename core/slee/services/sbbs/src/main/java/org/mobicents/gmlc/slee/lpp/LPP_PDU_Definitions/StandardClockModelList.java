...
public class StandardClockModelList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "StandardClockModelList";
   }

   protected StandardClockModelElement[] elements;
    ...
    * populated.
    */
   public StandardClockModelList (int numRecords) {
      elements = new StandardClockModelElement [numRecords];
   }
    ...
    * given the array.  
    */
   public StandardClockModelList (StandardClockModelElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof StandardClockModelList) ) return false;
      StandardClockModelList rhs = (StandardClockModelList) obj;
      StandardClockModelElement[] rhsElements = rhs.elements;
    ...
    */
   public StandardClockModelElement[] getElements () {
      return elements;
   }
   public void setElements (StandardClockModelElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new StandardClockModelElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new StandardClockModelElement();
