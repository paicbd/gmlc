...
public class FKP_Gradients_List_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FKP-Gradients-List-r15";
   }

   protected FKP_Gradients_Element_r15[] elements;

   public FKP_Gradients_List_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FKP_Gradients_List_r15 (int numRecords) {
      elements = new FKP_Gradients_Element_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FKP_Gradients_List_r15 (FKP_Gradients_Element_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof FKP_Gradients_List_r15) ) return false;
      FKP_Gradients_List_r15 rhs = (FKP_Gradients_List_r15) obj;
      FKP_Gradients_Element_r15[] rhsElements = rhs.elements;
    ...
    */
   public FKP_Gradients_Element_r15[] getElements () {
      return elements;
   }
   public void setElements (FKP_Gradients_Element_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FKP_Gradients_Element_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FKP_Gradients_Element_r15();
