...
public class CommonIEsProvideCapabilities_lpp_message_segmentation_r14 extends Asn1BitString {
    ...
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 (int numbits_, byte[] data) {
      super (numbits_, data);
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 (boolean[] bitValues) {
      super (bitValues);
      trimZeroBits = true;
   }
    ...
    *
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 (String value_) throws Asn1ValueParseException {
      super (value_);
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsProvideCapabilities_lpp_message_segmentation_r14 (java.util.BitSet bitSet) {
      super (bitSet);
      trimZeroBits = true;
   }
