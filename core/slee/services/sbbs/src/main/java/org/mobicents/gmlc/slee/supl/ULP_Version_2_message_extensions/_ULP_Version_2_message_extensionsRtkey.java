...
class _ULP_Version_2_message_extensionsRtkey {
   ...
   public static String _licLocation = _ULP_Version_2_message_extensionsRtkey.class.getResource("/osyslic.txt").getPath();
