...
public class SSR_PhaseBiasSatList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSR-PhaseBiasSatList-r16";
   }

   protected SSR_PhaseBiasSatElement_r16[] elements;

   public SSR_PhaseBiasSatList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSR_PhaseBiasSatList_r16 (int numRecords) {
      elements = new SSR_PhaseBiasSatElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSR_PhaseBiasSatList_r16 (SSR_PhaseBiasSatElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SSR_PhaseBiasSatList_r16) ) return false;
      SSR_PhaseBiasSatList_r16 rhs = (SSR_PhaseBiasSatList_r16) obj;
      SSR_PhaseBiasSatElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public SSR_PhaseBiasSatElement_r16[] getElements () {
      return elements;
   }
   public void setElements (SSR_PhaseBiasSatElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSR_PhaseBiasSatElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSR_PhaseBiasSatElement_r16();
