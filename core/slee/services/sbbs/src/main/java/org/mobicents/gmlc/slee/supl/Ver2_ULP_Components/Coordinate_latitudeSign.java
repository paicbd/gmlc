...
public class Coordinate_latitudeSign extends Asn1Enumerated {
   ...
   // Singleton instances of Coordinate_latitudeSign
   protected static final Coordinate_latitudeSign _north = new Coordinate_latitudeSign(0);
   protected static final Coordinate_latitudeSign _south = new Coordinate_latitudeSign(1);
    ...
    *   1
    */
   protected Coordinate_latitudeSign (int value_) {
      super (value_);
   }
   ...
   public static class Decoder implements Asn1PerDecoder{
      ...
      {
         return Coordinate_latitudeSign.valueOf( Coordinate_latitudeSign.decodeEnumValue( buffer ) );
      }
   }
    ...
    */
   public static Coordinate_latitudeSign valueOf (int _value)
