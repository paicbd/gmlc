...
public class AccessTypes_accessTypes extends Asn1BitString {
   ...
   public final static int eutra = 0;
   public final static int utra = 1;
   public final static int gsm = 2;
   public final static int nb_iot = 3;
   public final static int nr_v1510 = 4;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public AccessTypes_accessTypes () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public AccessTypes_accessTypes (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public AccessTypes_accessTypes (int numbits_, byte[] data) 
    ...
    */
   public AccessTypes_accessTypes (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public AccessTypes_accessTypes (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public AccessTypes_accessTypes (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
