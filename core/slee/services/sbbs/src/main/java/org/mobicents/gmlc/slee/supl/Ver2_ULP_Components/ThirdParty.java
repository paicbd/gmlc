...
public class ThirdParty extends Asn1SeqOf {
   ...
   protected ThirdPartyID[] elements;
    ...
    * populated.
    */
   public ThirdParty (int numRecords) {
      elements = new ThirdPartyID [numRecords];
   }
    ...
    * given the array.  
    */
   public ThirdParty (ThirdPartyID[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ThirdParty) ) return false;
      ThirdParty rhs = (ThirdParty) obj;
      ThirdPartyID[] rhsElements = rhs.elements;
    ...
    */
   public ThirdPartyID[] getElements () {
      return elements;
   }
   public void setElements (ThirdPartyID[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ThirdPartyID [numElements];
