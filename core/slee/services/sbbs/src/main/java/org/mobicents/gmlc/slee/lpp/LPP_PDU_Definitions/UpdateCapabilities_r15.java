...
public class UpdateCapabilities_r15 extends Asn1BitString {
    ...
    */
   public UpdateCapabilities_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public UpdateCapabilities_r15 (int numbits_, byte[] data) 
    ...
    */
   public UpdateCapabilities_r15 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public UpdateCapabilities_r15 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public UpdateCapabilities_r15 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
