...
public class GNSS_SSR_PhaseBias_r16 extends Asn1Seq {
    ...
    * the given objects 
    */
   public GNSS_SSR_PhaseBias_r16 (GNSS_SystemTime epochTime_r16_,
   ...
   public void init () {
      ...
      iod_ssr_r16 = null;
      ssr_PhaseBiasSatList_r16 = null;
      extElem1 = null;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof GNSS_SSR_PhaseBias_r16) ) return false;

      GNSS_SSR_PhaseBias_r16 rhs = (GNSS_SSR_PhaseBias_r16) obj;
      ...
      if (ssr_PhaseBiasSatList_r16 == null) {
         if (rhs.ssr_PhaseBiasSatList_r16 != null) return false;
      }
      else {
         if (!ssr_PhaseBiasSatList_r16.equals(rhs.ssr_PhaseBiasSatList_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (ssr_PhaseBiasSatList_r16 != null) __code = 31*__code + ssr_PhaseBiasSatList_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for Ssr_PhaseBiasSatList_r16
    */
   public SSR_PhaseBiasSatList_r16 getSsr_PhaseBiasSatList_r16 () {
      return ssr_PhaseBiasSatList_r16;
   }

   public void setSsr_PhaseBiasSatList_r16 (SSR_PhaseBiasSatList_r16 value) 
      throws Asn1Exception
   {
      ...
      this.ssr_PhaseBiasSatList_r16 = value;
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 3: return ssr_PhaseBiasSatList_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 3: return "ssr-PhaseBiasSatList-r16";
         case 4: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // decode ssr_PhaseBiasSatList_r16

      buffer.getContext().eventDispatcher.startElement("ssr_PhaseBiasSatList_r16", -1);

      ssr_PhaseBiasSatList_r16 = new SSR_PhaseBiasSatList_r16();
      ssr_PhaseBiasSatList_r16.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("ssr_PhaseBiasSatList_r16", -1);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode ssr_PhaseBiasSatList_r16

      if (ssr_PhaseBiasSatList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssr_PhaseBiasSatList_r16", -1);

         ssr_PhaseBiasSatList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ssr_PhaseBiasSatList_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ssr_PhaseBiasSatList_r16");
