...
public class TBS_Error_r13 extends Asn1Choice {
   ...
   public TBS_Error_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public TBS_LocationServerErrorCauses_r13 getLocationServerErrorCauses_r13 () {
      return (choiceID == _LOCATIONSERVERERRORCAUSES_R13) ? (TBS_LocationServerErrorCauses_r13)element : null;
   }
   public void setLocationServerErrorCauses_r13 (TBS_LocationServerErrorCauses_r13 value) {
   ...
   public TBS_TargetDeviceErrorCauses_r13 getTargetDeviceErrorCauses_r13 () {
      return (choiceID == _TARGETDEVICEERRORCAUSES_R13) ? (TBS_TargetDeviceErrorCauses_r13)element : null;
   }
   public void setTargetDeviceErrorCauses_r13 (TBS_TargetDeviceErrorCauses_r13 value) {
      ...
      if (!extbit) {
         ...
         switch (idx) {
            ...
            case 0: { 
               ...
               element = locationServerErrorCauses_r13 = new TBS_LocationServerErrorCauses_r13();
            ...
            case 1: { 
               ...
               element = targetDeviceErrorCauses_r13 = new TBS_TargetDeviceErrorCauses_r13();
      ...
      if (!extbit) {
         ...
         switch (choiceID) {
            ...
            case _LOCATIONSERVERERRORCAUSES_R13:
               TBS_LocationServerErrorCauses_r13 locationServerErrorCauses_r13 = (TBS_LocationServerErrorCauses_r13) element;
               locationServerErrorCauses_r13.encode (buffer);
               break;

            // targetDeviceErrorCauses_r13
            case _TARGETDEVICEERRORCAUSES_R13:
               TBS_TargetDeviceErrorCauses_r13 targetDeviceErrorCauses_r13 = (TBS_TargetDeviceErrorCauses_r13) element;
