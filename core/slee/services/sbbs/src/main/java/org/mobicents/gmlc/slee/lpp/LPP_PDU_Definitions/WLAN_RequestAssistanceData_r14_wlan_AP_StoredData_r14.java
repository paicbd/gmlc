...
public class WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14 extends Asn1SeqOf {
   ...
   protected WLAN_AP_Identifier_r13[] elements;

   public WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14 (int numRecords) {
      elements = new WLAN_AP_Identifier_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14 (WLAN_AP_Identifier_r13[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14) ) return false;
      WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14 rhs = (WLAN_RequestAssistanceData_r14_wlan_AP_StoredData_r14) obj;
      WLAN_AP_Identifier_r13[] rhsElements = rhs.elements;
    ...
    */
   public WLAN_AP_Identifier_r13[] getElements () {
      return elements;
   }
   public void setElements (WLAN_AP_Identifier_r13[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_AP_Identifier_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_AP_Identifier_r13();
