...
public class SSR_URA_SatList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSR-URA-SatList-r16";
   }

   protected SSR_URA_SatElement_r16[] elements;

   public SSR_URA_SatList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSR_URA_SatList_r16 (int numRecords) {
      elements = new SSR_URA_SatElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSR_URA_SatList_r16 (SSR_URA_SatElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SSR_URA_SatList_r16) ) return false;
      SSR_URA_SatList_r16 rhs = (SSR_URA_SatList_r16) obj;
      SSR_URA_SatElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public SSR_URA_SatElement_r16[] getElements () {
      return elements;
   }
   public void setElements (SSR_URA_SatElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSR_URA_SatElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSR_URA_SatElement_r16();
