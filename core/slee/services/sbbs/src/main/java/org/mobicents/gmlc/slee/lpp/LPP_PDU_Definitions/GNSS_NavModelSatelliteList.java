...
public class GNSS_NavModelSatelliteList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-NavModelSatelliteList";
   }

   protected GNSS_NavModelSatelliteElement[] elements;
    ...
    * populated.
    */
   public GNSS_NavModelSatelliteList (int numRecords) {
      elements = new GNSS_NavModelSatelliteElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_NavModelSatelliteList (GNSS_NavModelSatelliteElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_NavModelSatelliteList) ) return false;
      GNSS_NavModelSatelliteList rhs = (GNSS_NavModelSatelliteList) obj;
      GNSS_NavModelSatelliteElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_NavModelSatelliteElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_NavModelSatelliteElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_NavModelSatelliteElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_NavModelSatelliteElement();
