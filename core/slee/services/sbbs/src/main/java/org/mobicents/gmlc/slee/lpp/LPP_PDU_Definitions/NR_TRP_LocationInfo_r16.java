...
public class NR_TRP_LocationInfo_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NR-TRP-LocationInfo-r16";
   }

   protected NR_TRP_LocationInfoPerFreqLayer_r16[] elements;

   public NR_TRP_LocationInfo_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_TRP_LocationInfo_r16 (int numRecords) {
      elements = new NR_TRP_LocationInfoPerFreqLayer_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_TRP_LocationInfo_r16 (NR_TRP_LocationInfoPerFreqLayer_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_TRP_LocationInfo_r16) ) return false;
      NR_TRP_LocationInfo_r16 rhs = (NR_TRP_LocationInfo_r16) obj;
      NR_TRP_LocationInfoPerFreqLayer_r16[] rhsElements = rhs.elements;
    ...
    */
   public NR_TRP_LocationInfoPerFreqLayer_r16[] getElements () {
      return elements;
   }
   public void setElements (NR_TRP_LocationInfoPerFreqLayer_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_TRP_LocationInfoPerFreqLayer_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_TRP_LocationInfoPerFreqLayer_r16();
