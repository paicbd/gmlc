...
public class WLAN_DataSet_r14_wlan_AP_List_r14 extends Asn1SeqOf {
   ...
   protected WLAN_AP_Data_r14[] elements;

   public WLAN_DataSet_r14_wlan_AP_List_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_DataSet_r14_wlan_AP_List_r14 (int numRecords) {
      elements = new WLAN_AP_Data_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_DataSet_r14_wlan_AP_List_r14 (WLAN_AP_Data_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof WLAN_DataSet_r14_wlan_AP_List_r14) ) return false;
      WLAN_DataSet_r14_wlan_AP_List_r14 rhs = (WLAN_DataSet_r14_wlan_AP_List_r14) obj;
      WLAN_AP_Data_r14[] rhsElements = rhs.elements;
    ...
    */
   public WLAN_AP_Data_r14[] getElements () {
      return elements;
   }
   public void setElements (WLAN_AP_Data_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_AP_Data_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_AP_Data_r14();
