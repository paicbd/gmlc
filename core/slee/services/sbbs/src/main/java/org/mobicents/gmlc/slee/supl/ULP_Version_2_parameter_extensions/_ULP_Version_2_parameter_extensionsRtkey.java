...
class _ULP_Version_2_parameter_extensionsRtkey {
   ...
   public static String _licLocation = _ULP_Version_2_parameter_extensionsRtkey.class.getResource("/osyslic.txt").getPath();
