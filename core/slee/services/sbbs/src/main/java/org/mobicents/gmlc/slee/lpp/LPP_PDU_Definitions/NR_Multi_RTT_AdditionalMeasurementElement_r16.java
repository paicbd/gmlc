...
public class NR_Multi_RTT_AdditionalMeasurementElement_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "NR-Multi-RTT-AdditionalMeasurementElement-r16";
   }
   ...
   protected NR_Multi_RTT_AdditionalMeasurementElement_r16_nr_UE_RxTxTimeDiffAdditional_r16 nr_UE_RxTxTimeDiffAdditional_r16;
   ...
   public NR_Multi_RTT_AdditionalMeasurementElement_r16 () {
      super();
      init();
   }
   ...
   public NR_Multi_RTT_AdditionalMeasurementElement_r16 (
      ...
      NR_Multi_RTT_AdditionalMeasurementElement_r16_nr_UE_RxTxTimeDiffAdditional_r16 nr_UE_RxTxTimeDiffAdditional_r16_,
      ...
      setNr_UE_RxTxTimeDiffAdditional_r16 (nr_UE_RxTxTimeDiffAdditional_r16_);
    ...
    * the given objects 
    */
   public NR_Multi_RTT_AdditionalMeasurementElement_r16 (long nr_DL_PRS_ResourceID_r16_,
   ...
   public void init () {
      ...
      nr_UE_RxTxTimeDiffAdditional_r16 = null;
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_Multi_RTT_AdditionalMeasurementElement_r16) ) return false;

      NR_Multi_RTT_AdditionalMeasurementElement_r16 rhs = (NR_Multi_RTT_AdditionalMeasurementElement_r16) obj;
      ...
      if (nr_UE_RxTxTimeDiffAdditional_r16 == null) {
         if (rhs.nr_UE_RxTxTimeDiffAdditional_r16 != null) return false;
      }
      else {
         if (!nr_UE_RxTxTimeDiffAdditional_r16.equals(rhs.nr_UE_RxTxTimeDiffAdditional_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (nr_UE_RxTxTimeDiffAdditional_r16 != null) __code = 31*__code + nr_UE_RxTxTimeDiffAdditional_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for Nr_UE_RxTxTimeDiffAdditional_r16
    */
   public NR_Multi_RTT_AdditionalMeasurementElement_r16_nr_UE_RxTxTimeDiffAdditional_r16 getNr_UE_RxTxTimeDiffAdditional_r16 () {
      return nr_UE_RxTxTimeDiffAdditional_r16;
   }

   public void setNr_UE_RxTxTimeDiffAdditional_r16 (NR_Multi_RTT_AdditionalMeasurementElement_r16_nr_UE_RxTxTimeDiffAdditional_r16 value) {
      this.nr_UE_RxTxTimeDiffAdditional_r16 = value;
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 2: return nr_DL_PRS_RSRP_ResultDiff_r16;
         case 3: return nr_UE_RxTxTimeDiffAdditional_r16;
         case 4: return nr_TimingQuality_r16;
         case 5: return nr_AdditionalPathList_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 2: return "nr-DL-PRS-RSRP-ResultDiff-r16";
         case 3: return "nr-UE-RxTxTimeDiffAdditional-r16";
         case 4: return "nr-TimingQuality-r16";
         case 5: return "nr-AdditionalPathList-r16";
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // decode nr_UE_RxTxTimeDiffAdditional_r16

      buffer.getContext().eventDispatcher.startElement("nr_UE_RxTxTimeDiffAdditional_r16", -1);

      nr_UE_RxTxTimeDiffAdditional_r16 = new NR_Multi_RTT_AdditionalMeasurementElement_r16_nr_UE_RxTxTimeDiffAdditional_r16();
      nr_UE_RxTxTimeDiffAdditional_r16.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("nr_UE_RxTxTimeDiffAdditional_r16", -1);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode nr_UE_RxTxTimeDiffAdditional_r16

      if (nr_UE_RxTxTimeDiffAdditional_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("nr_UE_RxTxTimeDiffAdditional_r16", -1);

         nr_UE_RxTxTimeDiffAdditional_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("nr_UE_RxTxTimeDiffAdditional_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("nr_UE_RxTxTimeDiffAdditional_r16");
