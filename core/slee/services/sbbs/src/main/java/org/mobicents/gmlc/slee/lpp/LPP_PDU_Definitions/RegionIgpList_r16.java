...
public class RegionIgpList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RegionIgpList-r16";
   }

   protected RegionIgpElement_r16[] elements;

   public RegionIgpList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RegionIgpList_r16 (int numRecords) {
      elements = new RegionIgpElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public RegionIgpList_r16 (RegionIgpElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RegionIgpList_r16) ) return false;
      RegionIgpList_r16 rhs = (RegionIgpList_r16) obj;
      RegionIgpElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public RegionIgpElement_r16[] getElements () {
      return elements;
   }
   public void setElements (RegionIgpElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RegionIgpElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RegionIgpElement_r16();
