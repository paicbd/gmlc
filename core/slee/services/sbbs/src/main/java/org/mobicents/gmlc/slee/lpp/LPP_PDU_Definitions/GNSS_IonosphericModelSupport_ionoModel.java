...
public class GNSS_IonosphericModelSupport_ionoModel extends Asn1BitString {
   ...
   public final static int klobuchar = 0;
   public final static int neQuick = 1;
   public final static int klobuchar2_r16 = 2;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public GNSS_IonosphericModelSupport_ionoModel () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public GNSS_IonosphericModelSupport_ionoModel (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public GNSS_IonosphericModelSupport_ionoModel (int numbits_, byte[] data) 
    ...
    */
   public GNSS_IonosphericModelSupport_ionoModel (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public GNSS_IonosphericModelSupport_ionoModel (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public GNSS_IonosphericModelSupport_ionoModel (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
