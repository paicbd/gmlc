...
public class GNSS_ReferenceTime_gnss_ReferenceTimeForCells extends Asn1SeqOf {
   ...
   protected GNSS_ReferenceTimeForOneCell[] elements;

   public GNSS_ReferenceTime_gnss_ReferenceTimeForCells () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNSS_ReferenceTime_gnss_ReferenceTimeForCells (int numRecords) {
      elements = new GNSS_ReferenceTimeForOneCell [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_ReferenceTime_gnss_ReferenceTimeForCells (GNSS_ReferenceTimeForOneCell[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_ReferenceTime_gnss_ReferenceTimeForCells) ) return false;
      GNSS_ReferenceTime_gnss_ReferenceTimeForCells rhs = (GNSS_ReferenceTime_gnss_ReferenceTimeForCells) obj;
      GNSS_ReferenceTimeForOneCell[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_ReferenceTimeForOneCell[] getElements () {
      return elements;
   }
   public void setElements (GNSS_ReferenceTimeForOneCell[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_ReferenceTimeForOneCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_ReferenceTimeForOneCell();
