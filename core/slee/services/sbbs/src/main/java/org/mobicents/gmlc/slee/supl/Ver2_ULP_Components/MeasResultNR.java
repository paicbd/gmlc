...
public class MeasResultNR extends Asn1Seq {
   ...
   protected CellGlobalIdNR cellGlobalId;  // optional
   protected TrackingAreaCodeNR trackingAreaCode;  // optional
   protected NR_Measurements ssb_Measurements;  // optional
   protected NR_Measurements csi_rs_Measurements;  // optional
   protected MeasResultNR_arfcn_type arfcn_type = null;  // optional
   ...
   public MeasResultNR (
      ...
      MeasResultNR_arfcn_type arfcn_type_,
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof MeasResultNR) ) return false;

      MeasResultNR rhs = (MeasResultNR) obj;
    ...
    */
   public MeasResultNR_arfcn_type getArfcn_type () {
      return arfcn_type;
   }

   public void setArfcn_type (MeasResultNR_arfcn_type value) {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 6: return arfcn_type;
         case 7: return systemFrameNumber;
         case 8: return ssb_IndexList_Measurements;
         case 9: return csi_rs_IndexList_Measurements;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 6: return "arfcn-type";
         case 7: return "systemFrameNumber";
         case 8: return "ssb-IndexList-Measurements";
         case 9: return "csi-rs-IndexList-Measurements";
         case 10: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (i < bitcnt && bitmap[i++]) {
            ...
            {
               int tval = MeasResultNR_arfcn_type.decodeEnumValue (buffer);
               arfcn_type = MeasResultNR_arfcn_type.valueOf (tval);
