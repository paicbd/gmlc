...
public class CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc extends Asn1SeqOf {
   ...
   protected Asn1Integer[] elements;

   public CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc (int numRecords) {
    ...
    * given the array.  
    */
   public CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc (Asn1Integer[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc) ) return false;
      CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc rhs = (CellGlobalIdEUTRA_AndUTRA_plmn_Identity_mcc) obj;
    ...
    */
   public Asn1Integer[] getElements () {
      return elements;
   }
   public void setElements (Asn1Integer[] value) {
      elements = value;
   }
