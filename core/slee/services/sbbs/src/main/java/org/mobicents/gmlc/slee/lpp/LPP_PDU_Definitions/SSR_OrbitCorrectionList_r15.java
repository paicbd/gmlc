...
public class SSR_OrbitCorrectionList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSR-OrbitCorrectionList-r15";
   }

   protected SSR_OrbitCorrectionSatelliteElement_r15[] elements;

   public SSR_OrbitCorrectionList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSR_OrbitCorrectionList_r15 (int numRecords) {
      elements = new SSR_OrbitCorrectionSatelliteElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSR_OrbitCorrectionList_r15 (SSR_OrbitCorrectionSatelliteElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SSR_OrbitCorrectionList_r15) ) return false;
      SSR_OrbitCorrectionList_r15 rhs = (SSR_OrbitCorrectionList_r15) obj;
      SSR_OrbitCorrectionSatelliteElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public SSR_OrbitCorrectionSatelliteElement_r15[] getElements () {
      return elements;
   }
   public void setElements (SSR_OrbitCorrectionSatelliteElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSR_OrbitCorrectionSatelliteElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSR_OrbitCorrectionSatelliteElement_r15();
