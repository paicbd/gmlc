...
public class OTDOA_ReferenceCellInfoNB_r14 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "OTDOA-ReferenceCellInfoNB-r14";
   }

   protected Asn1Integer physCellIdNB_r14;  // optional
   protected ECGI cellGlobalIdNB_r14;  // optional
   protected CarrierFreq_NB_r14 carrierFreqRef_r14;  // optional
   protected ARFCN_ValueEUTRA_r14 earfcn_r14;  // optional
   protected OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14 eutra_NumCRS_Ports_r14 = null;  // optional
   protected OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14 otdoa_SIB1_NB_repetitions_r14 = null;  // optional
   ...
   public OTDOA_ReferenceCellInfoNB_r14 () {
      super();
      init();
   }
   ...
   public OTDOA_ReferenceCellInfoNB_r14 (
      ...
      CarrierFreq_NB_r14 carrierFreqRef_r14_,
      ARFCN_ValueEUTRA_r14 earfcn_r14_,
      OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14 eutra_NumCRS_Ports_r14_,
      OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14 otdoa_SIB1_NB_repetitions_r14_,
      ...
      setCarrierFreqRef_r14 (carrierFreqRef_r14_);
    ...
    * the given objects 
    */
   public OTDOA_ReferenceCellInfoNB_r14 (long physCellIdNB_r14_,
      ECGI cellGlobalIdNB_r14_,
      CarrierFreq_NB_r14 carrierFreqRef_r14_,
      long earfcn_r14_,
      OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14 eutra_NumCRS_Ports_r14_,
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_ReferenceCellInfoNB_r14) ) return false;

      OTDOA_ReferenceCellInfoNB_r14 rhs = (OTDOA_ReferenceCellInfoNB_r14) obj;
      ...
      if (carrierFreqRef_r14 == null) {
         if (rhs.carrierFreqRef_r14 != null) return false;
      }
      else {
         if (!carrierFreqRef_r14.equals(rhs.carrierFreqRef_r14)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (carrierFreqRef_r14 != null) __code = 31*__code + carrierFreqRef_r14.hashCode();
   ...
   /**
    * Accessor/mutator methods for CarrierFreqRef_r14
    */
   public CarrierFreq_NB_r14 getCarrierFreqRef_r14 () {
      return carrierFreqRef_r14;
   }

   public void setCarrierFreqRef_r14 (CarrierFreq_NB_r14 value) {
      this.carrierFreqRef_r14 = value;
   }

   public boolean hasCarrierFreqRef_r14 () {
      return (carrierFreqRef_r14 != null);
   }
    ...
    */
   public OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14 getEutra_NumCRS_Ports_r14 () {
      return eutra_NumCRS_Ports_r14;
   }

   public void setEutra_NumCRS_Ports_r14 (OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14 value) {
    ...
    */
   public OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14 getOtdoa_SIB1_NB_repetitions_r14 () {
      return otdoa_SIB1_NB_repetitions_r14;
   }

   public void setOtdoa_SIB1_NB_repetitions_r14 (OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14 value) {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 2: return carrierFreqRef_r14;
         ...
         case 7: return nprsInfo_Type2_v1470;
         case 8: return tdd_config_r15;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 2: return "carrierFreqRef-r14";
         ...
         case 7: return "nprsInfo-Type2-v1470";
         case 8: return "tdd-config-r15";
         case 9: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean carrierFreqRef_r14Present = buffer.decodeBit ("carrierFreqRef_r14Present");
      ...
      // decode carrierFreqRef_r14

      if (carrierFreqRef_r14Present) {
         buffer.getContext().eventDispatcher.startElement("carrierFreqRef_r14", -1);

         carrierFreqRef_r14 = new CarrierFreq_NB_r14();
         carrierFreqRef_r14.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("carrierFreqRef_r14", -1);
      }
      else {
         carrierFreqRef_r14 = null;
      }
      ...
      if (eutra_NumCRS_Ports_r14Present) {
         ...
         int tval = OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14.decodeEnumValue (buffer);
         eutra_NumCRS_Ports_r14 = OTDOA_ReferenceCellInfoNB_r14_eutra_NumCRS_Ports_r14.valueOf (tval);
      ...
      if (otdoa_SIB1_NB_repetitions_r14Present) {
         ...
         int tval = OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14.decodeEnumValue (buffer);
         otdoa_SIB1_NB_repetitions_r14 = OTDOA_ReferenceCellInfoNB_r14_otdoa_SIB1_NB_repetitions_r14.valueOf (tval);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((carrierFreqRef_r14 != null), null);
      ...
      // encode carrierFreqRef_r14

      if (carrierFreqRef_r14 != null) {
         buffer.getContext().eventDispatcher.startElement("carrierFreqRef_r14", -1);

         carrierFreqRef_r14.encode (buffer);
