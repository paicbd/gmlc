...
public class GANSSPositionMethods extends Asn1SeqOf {
   ...
   protected GANSSPositionMethod[] elements;
    ...
    * populated.
    */
   public GANSSPositionMethods (int numRecords) {
      elements = new GANSSPositionMethod [numRecords];
   }
    ...
    * given the array.  
    */
   public GANSSPositionMethods (GANSSPositionMethod[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GANSSPositionMethods) ) return false;
      GANSSPositionMethods rhs = (GANSSPositionMethods) obj;
      GANSSPositionMethod[] rhsElements = rhs.elements;
    ...
    */
   public GANSSPositionMethod[] getElements () {
      return elements;
   }
   public void setElements (GANSSPositionMethod[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GANSSPositionMethod [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GANSSPositionMethod();
