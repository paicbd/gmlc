...
public class HorizontalAccuracy extends Asn1Seq {
    ...
    * the given objects 
    */
   public HorizontalAccuracy (long accuracy_,
      long confidence_
   ) throws Asn1Exception {
      super();
      setAccuracy (accuracy_);
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof HorizontalAccuracy) ) return false;

      HorizontalAccuracy rhs = (HorizontalAccuracy) obj;
