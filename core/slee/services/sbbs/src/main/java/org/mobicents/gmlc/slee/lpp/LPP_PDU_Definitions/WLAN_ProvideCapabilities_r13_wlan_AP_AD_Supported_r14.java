...
public class WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 extends Asn1BitString {
   ...
   public final static int ap_identifier = 0;
   public final static int ap_location = 1;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 (int numbits_, byte[] data) 
    ...
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public WLAN_ProvideCapabilities_r13_wlan_AP_AD_Supported_r14 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
