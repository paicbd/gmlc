...
public class GNSS_ID_BDS_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-ID-BDS-r16";
   }

   protected GNSS_ID_BDS_SatElement_r16[] elements;

   public GNSS_ID_BDS_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNSS_ID_BDS_r16 (int numRecords) {
      elements = new GNSS_ID_BDS_SatElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_ID_BDS_r16 (GNSS_ID_BDS_SatElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_ID_BDS_r16) ) return false;
      GNSS_ID_BDS_r16 rhs = (GNSS_ID_BDS_r16) obj;
      GNSS_ID_BDS_SatElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_ID_BDS_SatElement_r16[] getElements () {
      return elements;
   }
   public void setElements (GNSS_ID_BDS_SatElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_ID_BDS_SatElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_ID_BDS_SatElement_r16();
