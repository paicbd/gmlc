...
public class NavIC_CorrectionListAutoNav_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NavIC-CorrectionListAutoNav-r16";
   }

   protected NavIC_CorrectionElementAutoNav_r16[] elements;

   public NavIC_CorrectionListAutoNav_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NavIC_CorrectionListAutoNav_r16 (int numRecords) {
      elements = new NavIC_CorrectionElementAutoNav_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NavIC_CorrectionListAutoNav_r16 (NavIC_CorrectionElementAutoNav_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NavIC_CorrectionListAutoNav_r16) ) return false;
      NavIC_CorrectionListAutoNav_r16 rhs = (NavIC_CorrectionListAutoNav_r16) obj;
      NavIC_CorrectionElementAutoNav_r16[] rhsElements = rhs.elements;
    ...
    */
   public NavIC_CorrectionElementAutoNav_r16[] getElements () {
      return elements;
   }
   public void setElements (NavIC_CorrectionElementAutoNav_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NavIC_CorrectionElementAutoNav_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NavIC_CorrectionElementAutoNav_r16();
