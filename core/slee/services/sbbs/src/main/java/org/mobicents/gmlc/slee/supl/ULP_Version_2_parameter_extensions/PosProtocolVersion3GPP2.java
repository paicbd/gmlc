...
public class PosProtocolVersion3GPP2 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PosProtocolVersion3GPP2";
   }

   protected Supported3GPP2PosProtocolVersion[] elements;
    ...
    * populated.
    */
   public PosProtocolVersion3GPP2 (int numRecords) {
      elements = new Supported3GPP2PosProtocolVersion [numRecords];
   }
    ...
    * given the array.  
    */
   public PosProtocolVersion3GPP2 (Supported3GPP2PosProtocolVersion[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof PosProtocolVersion3GPP2) ) return false;
      PosProtocolVersion3GPP2 rhs = (PosProtocolVersion3GPP2) obj;
      Supported3GPP2PosProtocolVersion[] rhsElements = rhs.elements;
    ...
    */
   public Supported3GPP2PosProtocolVersion[] getElements () {
      return elements;
   }
   public void setElements (Supported3GPP2PosProtocolVersion[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Supported3GPP2PosProtocolVersion [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Supported3GPP2PosProtocolVersion();
