...
public class DisplacementInfoList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DisplacementInfoList-r15";
   }

   protected DisplacementInfoListElement_r15[] elements;

   public DisplacementInfoList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DisplacementInfoList_r15 (int numRecords) {
      elements = new DisplacementInfoListElement_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public DisplacementInfoList_r15 (DisplacementInfoListElement_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof DisplacementInfoList_r15) ) return false;
      DisplacementInfoList_r15 rhs = (DisplacementInfoList_r15) obj;
      DisplacementInfoListElement_r15[] rhsElements = rhs.elements;
    ...
    */
   public DisplacementInfoListElement_r15[] getElements () {
      return elements;
   }
   public void setElements (DisplacementInfoListElement_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DisplacementInfoListElement_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DisplacementInfoListElement_r15();
