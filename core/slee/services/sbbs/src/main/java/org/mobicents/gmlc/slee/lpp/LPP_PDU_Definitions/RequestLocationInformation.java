...
public class RequestLocationInformation extends Asn1Seq {
   ...
   protected RequestLocationInformation_criticalExtensions criticalExtensions;
    ...
    */
   public RequestLocationInformation (
      RequestLocationInformation_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RequestLocationInformation) ) return false;

      RequestLocationInformation rhs = (RequestLocationInformation) obj;
    ...
    */
   public RequestLocationInformation_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (RequestLocationInformation_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RequestLocationInformation_criticalExtensions();
