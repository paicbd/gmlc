...
public class NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 extends Asn1BitString {
   ...
   public final static int ssrsrpSup = 0;
   public final static int ssrsrqSup = 1;
   public final static int csirsrpSup = 2;
   public final static int csirsrqSup = 3;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 (int numbits_, byte[] data) 
    ...
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public NR_ECID_ProvideCapabilities_r16_nr_ECID_MeasSupported_r16 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
