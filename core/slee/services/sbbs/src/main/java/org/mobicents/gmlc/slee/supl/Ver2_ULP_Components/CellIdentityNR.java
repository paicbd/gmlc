...
public class CellIdentityNR extends Asn1BitString {
    ...
    */
   public CellIdentityNR (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public CellIdentityNR (int numbits_, byte[] data) 
    ...
    */
   public CellIdentityNR (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!(getLength() == 36)) {
    ...
    *
    */
   public CellIdentityNR (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!(getLength() == 36)) {
    ...
    */
   public CellIdentityNR (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!(getLength() == 36)) {
