...
public class TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 extends Asn1BitString {
   ...
   public final static int tb1 = 0;
   public final static int tb2 = 1;
   public final static int tb3 = 2;
   public final static int tb4 = 3;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 (int numbits_, byte[] data) 
    ...
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public TBS_ProvideCapabilities_r13_mbs_ConfigSupport_r14 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
