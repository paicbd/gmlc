...
public class OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14 extends Asn1SeqOf {
   ...
   protected Add_PRSconfigNeighbourElement_r14[] elements;

   public OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14 (int numRecords) {
      elements = new Add_PRSconfigNeighbourElement_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14 (Add_PRSconfigNeighbourElement_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14) ) return false;
      OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14 rhs = (OTDOA_NeighbourCellInfoElement_addPRSconfigNeighbour_r14) obj;
      Add_PRSconfigNeighbourElement_r14[] rhsElements = rhs.elements;
    ...
    */
   public Add_PRSconfigNeighbourElement_r14[] getElements () {
      return elements;
   }
   public void setElements (Add_PRSconfigNeighbourElement_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Add_PRSconfigNeighbourElement_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Add_PRSconfigNeighbourElement_r14();
