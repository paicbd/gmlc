...
public class DL_PRS_BeamInfoResourceSet_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DL-PRS-BeamInfoResourceSet-r16";
   }

   protected DL_PRS_BeamInfoElement_r16[] elements;

   public DL_PRS_BeamInfoResourceSet_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DL_PRS_BeamInfoResourceSet_r16 (int numRecords) {
      elements = new DL_PRS_BeamInfoElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public DL_PRS_BeamInfoResourceSet_r16 (DL_PRS_BeamInfoElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof DL_PRS_BeamInfoResourceSet_r16) ) return false;
      DL_PRS_BeamInfoResourceSet_r16 rhs = (DL_PRS_BeamInfoResourceSet_r16) obj;
      DL_PRS_BeamInfoElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public DL_PRS_BeamInfoElement_r16[] getElements () {
      return elements;
   }
   public void setElements (DL_PRS_BeamInfoElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DL_PRS_BeamInfoElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DL_PRS_BeamInfoElement_r16();
