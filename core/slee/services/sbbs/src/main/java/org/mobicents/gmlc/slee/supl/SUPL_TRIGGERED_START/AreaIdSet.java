...
public class AreaIdSet extends Asn1SeqOf {
    ...
    * populated.
    */
   public AreaIdSet (int numRecords) {
      elements = new AreaId [numRecords];
   }
    ...
    * given the array.  
    */
   public AreaIdSet (AreaId[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AreaIdSet) ) return false;
      AreaIdSet rhs = (AreaIdSet) obj;
      AreaId[] rhsElements = rhs.elements;
    ...
    */
   public AreaId[] getElements () {
      return elements;
   }
   public void setElements (AreaId[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AreaId [numElements];
