...
public class A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 extends Asn1BitString {
   ...
   public final static int solicited = 0;
   public final static int unsolicited = 1;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 (int numbits_, byte[] data) 
    ...
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public A_GNSS_ProvideCapabilities_periodicAssistanceData_r15 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
