...
public class NeighbourMeasurementList extends Asn1SeqOf {
   ...
   protected NeighbourMeasurementElement[] elements;
    ...
    * populated.
    */
   public NeighbourMeasurementList (int numRecords) {
      elements = new NeighbourMeasurementElement [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighbourMeasurementList (NeighbourMeasurementElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NeighbourMeasurementList) ) return false;
      NeighbourMeasurementList rhs = (NeighbourMeasurementList) obj;
      NeighbourMeasurementElement[] rhsElements = rhs.elements;
    ...
    */
   public NeighbourMeasurementElement[] getElements () {
      return elements;
   }
   public void setElements (NeighbourMeasurementElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighbourMeasurementElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighbourMeasurementElement();
