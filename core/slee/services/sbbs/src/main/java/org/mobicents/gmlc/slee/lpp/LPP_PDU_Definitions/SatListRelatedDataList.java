...
public class SatListRelatedDataList extends Asn1SeqOf {
   ...
   protected SatListRelatedDataElement[] elements;
    ...
    * populated.
    */
   public SatListRelatedDataList (int numRecords) {
      elements = new SatListRelatedDataElement [numRecords];
   }
    ...
    * given the array.  
    */
   public SatListRelatedDataList (SatListRelatedDataElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SatListRelatedDataList) ) return false;
      SatListRelatedDataList rhs = (SatListRelatedDataList) obj;
      SatListRelatedDataElement[] rhsElements = rhs.elements;
    ...
    */
   public SatListRelatedDataElement[] getElements () {
      return elements;
   }
   public void setElements (SatListRelatedDataElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SatListRelatedDataElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SatListRelatedDataElement();
