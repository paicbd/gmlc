...
public class ReqNavListInfo_clockModelID_PrefList extends Asn1SeqOf {
   ...
   public ReqNavListInfo_clockModelID_PrefList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReqNavListInfo_clockModelID_PrefList (int numRecords) {
    ...
    * given the array.  
    */
   public ReqNavListInfo_clockModelID_PrefList (Asn1Integer[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ReqNavListInfo_clockModelID_PrefList) ) return false;
      ReqNavListInfo_clockModelID_PrefList rhs = (ReqNavListInfo_clockModelID_PrefList) obj;
