...
public class OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0 extends Asn1SeqOf {
   ...
   protected SupportedBandEUTRA_v9a0[] elements;

   public OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0 (int numRecords) {
      elements = new SupportedBandEUTRA_v9a0 [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0 (SupportedBandEUTRA_v9a0[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0) ) return false;
      OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0 rhs = (OTDOA_ProvideCapabilities_supportedBandListEUTRA_v9a0) obj;
      SupportedBandEUTRA_v9a0[] rhsElements = rhs.elements;
    ...
    */
   public SupportedBandEUTRA_v9a0[] getElements () {
      return elements;
   }
   public void setElements (SupportedBandEUTRA_v9a0[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandEUTRA_v9a0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandEUTRA_v9a0();
