...
public class BT_ProvideCapabilities_r13_bt_MeasSupported_r13 extends Asn1BitString {
    ...
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 (int numbits_, byte[] data) 
    ...
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public BT_ProvideCapabilities_r13_bt_MeasSupported_r13 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
