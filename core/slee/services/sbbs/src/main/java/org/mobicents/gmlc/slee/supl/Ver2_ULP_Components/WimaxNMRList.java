...
public class WimaxNMRList extends Asn1SeqOf {
    ...
    * populated.
    */
   public WimaxNMRList (int numRecords) {
      elements = new WimaxNMR [numRecords];
   }
    ...
    * given the array.  
    */
   public WimaxNMRList (WimaxNMR[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof WimaxNMRList) ) return false;
      WimaxNMRList rhs = (WimaxNMRList) obj;
      WimaxNMR[] rhsElements = rhs.elements;
    ...
    */
   public WimaxNMR[] getElements () {
      return elements;
   }
   public void setElements (WimaxNMR[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WimaxNMR [numElements];
