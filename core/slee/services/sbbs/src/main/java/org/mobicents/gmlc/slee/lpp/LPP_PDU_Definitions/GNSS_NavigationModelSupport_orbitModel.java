...
public class GNSS_NavigationModelSupport_orbitModel extends Asn1BitString {
    ...
    */
   public GNSS_NavigationModelSupport_orbitModel () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public GNSS_NavigationModelSupport_orbitModel (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public GNSS_NavigationModelSupport_orbitModel (int numbits_, byte[] data) 
    ...
    */
   public GNSS_NavigationModelSupport_orbitModel (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public GNSS_NavigationModelSupport_orbitModel (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public GNSS_NavigationModelSupport_orbitModel (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
