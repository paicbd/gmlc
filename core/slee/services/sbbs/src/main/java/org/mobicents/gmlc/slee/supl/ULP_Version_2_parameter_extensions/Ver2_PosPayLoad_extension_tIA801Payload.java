...
public class Ver2_PosPayLoad_extension_tIA801Payload extends Asn1SeqOf {
   ...
   protected Asn1OctetString[] elements;

   public Ver2_PosPayLoad_extension_tIA801Payload () {
      elements = null;
   }
    ...
    * populated.
    */
   public Ver2_PosPayLoad_extension_tIA801Payload (int numRecords) {
    ...
    * given the array.  
    */
   public Ver2_PosPayLoad_extension_tIA801Payload (Asn1OctetString[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof Ver2_PosPayLoad_extension_tIA801Payload) ) return false;
      Ver2_PosPayLoad_extension_tIA801Payload rhs = (Ver2_PosPayLoad_extension_tIA801Payload) obj;
    ...
    */
   public Asn1OctetString[] getElements () {
      return elements;
   }
   public void setElements (Asn1OctetString[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 1, 60000);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].encode (buffer, 1, 60000);
