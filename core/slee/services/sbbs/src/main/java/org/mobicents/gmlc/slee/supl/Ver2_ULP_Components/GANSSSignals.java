...
public class GANSSSignals extends Asn1BitString {
   ...
   public final static int signal1 = 0;
   public final static int signal2 = 1;
   public final static int signal3 = 2;
   public final static int signal4 = 3;
   public final static int signal5 = 4;
   public final static int signal6 = 5;
   public final static int signal7 = 6;
   public final static int signal8 = 7;
    ...
    * @param data       Binary bit string contents
    */
   public GANSSSignals (int numbits_, byte[] data) 
    ...
    */
   public GANSSSignals (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public GANSSSignals (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public GANSSSignals (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
