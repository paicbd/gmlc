...
public class ReportDataList extends Asn1SeqOf {
    ...
    * populated.
    */
   public ReportDataList (int numRecords) {
      elements = new ReportData [numRecords];
   }
    ...
    * given the array.  
    */
   public ReportDataList (ReportData[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ReportDataList) ) return false;
      ReportDataList rhs = (ReportDataList) obj;
      ReportData[] rhsElements = rhs.elements;
    ...
    */
   public ReportData[] getElements () {
      return elements;
   }
   public void setElements (ReportData[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReportData [numElements];
