...
public class GNSS_MeasurementList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-MeasurementList";
   }

   protected GNSS_MeasurementForOneGNSS[] elements;
    ...
    * populated.
    */
   public GNSS_MeasurementList (int numRecords) {
      elements = new GNSS_MeasurementForOneGNSS [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_MeasurementList (GNSS_MeasurementForOneGNSS[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_MeasurementList) ) return false;
      GNSS_MeasurementList rhs = (GNSS_MeasurementList) obj;
      GNSS_MeasurementForOneGNSS[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_MeasurementForOneGNSS[] getElements () {
      return elements;
   }
   public void setElements (GNSS_MeasurementForOneGNSS[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_MeasurementForOneGNSS [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_MeasurementForOneGNSS();
