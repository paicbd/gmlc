...
public class GNSS_AlmanacList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-AlmanacList";
   }

   protected GNSS_AlmanacElement[] elements;
    ...
    * populated.
    */
   public GNSS_AlmanacList (int numRecords) {
      elements = new GNSS_AlmanacElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_AlmanacList (GNSS_AlmanacElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_AlmanacList) ) return false;
      GNSS_AlmanacList rhs = (GNSS_AlmanacList) obj;
      GNSS_AlmanacElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_AlmanacElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_AlmanacElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_AlmanacElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_AlmanacElement();
