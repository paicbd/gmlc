...
public class RTD_InfoElement_r16 extends Asn1Seq {
   ...
   protected Asn1Integer subframeOffset_r16;
   protected NR_TimingQuality_r16 rtd_Quality_r16;
   protected Asn1OpenExt extElem1;

   public RTD_InfoElement_r16 () {
      super();
      init();
   }
   ...
   public RTD_InfoElement_r16 (
      ...
      Asn1Integer subframeOffset_r16_,
      NR_TimingQuality_r16 rtd_Quality_r16_
      ...
      setSubframeOffset_r16 (subframeOffset_r16_);
      setRtd_Quality_r16 (rtd_Quality_r16_);
   }
    ...
    * the given objects 
    */
   public RTD_InfoElement_r16 (long dl_PRS_ID_r16_,
      long nr_PhysCellID_r16_,
      NCGI_r15 nr_CellGlobalID_r16_,
      long nr_ARFCN_r16_,
      long subframeOffset_r16_,
      NR_TimingQuality_r16 rtd_Quality_r16_
   ) throws Asn1Exception {
      super();
      setDl_PRS_ID_r16 (dl_PRS_ID_r16_);
   ...
   public void init () {
      ...
      nr_ARFCN_r16 = null;
      subframeOffset_r16 = null;
      rtd_Quality_r16 = null;
      extElem1 = null;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof RTD_InfoElement_r16) ) return false;

      RTD_InfoElement_r16 rhs = (RTD_InfoElement_r16) obj;
      ...
      if (subframeOffset_r16 == null) {
         if (rhs.subframeOffset_r16 != null) return false;
      }
      else {
         if (!subframeOffset_r16.equals(rhs.subframeOffset_r16)) {
            return false;
         }
      }

      if (rtd_Quality_r16 == null) {
         if (rhs.rtd_Quality_r16 != null) return false;
      }
      else {
         if (!rtd_Quality_r16.equals(rhs.rtd_Quality_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (subframeOffset_r16 != null) __code = 31*__code + subframeOffset_r16.hashCode();
      if (rtd_Quality_r16 != null) __code = 31*__code + rtd_Quality_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for SubframeOffset_r16
    */
   public Asn1Integer getSubframeOffset_r16 () {
      return subframeOffset_r16;
   }

   public void setSubframeOffset_r16 (Asn1Integer value) 
      throws Asn1Exception
   {
      if (!((value.value >= 0 && value.value <= 1966079))) {
         throw new Asn1ConsVioException ("value.value", value.value);
      }

      this.subframeOffset_r16 = value;
   }

   public void setSubframeOffset_r16 (long value) 
      throws Asn1Exception
   {
      setSubframeOffset_r16 (new Asn1Integer(value));
   }

   /**
    * Accessor/mutator methods for Rtd_Quality_r16
    */
   public NR_TimingQuality_r16 getRtd_Quality_r16 () {
      return rtd_Quality_r16;
   }

   public void setRtd_Quality_r16 (NR_TimingQuality_r16 value) {
      this.rtd_Quality_r16 = value;
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 4: return subframeOffset_r16;
         case 5: return rtd_Quality_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 4: return "subframeOffset-r16";
         case 5: return "rtd-Quality-r16";
         case 6: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // decode subframeOffset_r16

      buffer.getContext().eventDispatcher.startElement("subframeOffset_r16", -1);

      subframeOffset_r16 = new Asn1Integer();
      subframeOffset_r16.decode (buffer, 0, 1966079);
      buffer.getContext().eventDispatcher.endElement("subframeOffset_r16", -1);

      // decode rtd_Quality_r16

      buffer.getContext().eventDispatcher.startElement("rtd_Quality_r16", -1);

      rtd_Quality_r16 = new NR_TimingQuality_r16();
      rtd_Quality_r16.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("rtd_Quality_r16", -1);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode subframeOffset_r16

      if (subframeOffset_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("subframeOffset_r16", -1);

         subframeOffset_r16.encode (buffer, 0, 1966079);

         buffer.getContext().eventDispatcher.endElement("subframeOffset_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("subframeOffset_r16");

      // encode rtd_Quality_r16

      if (rtd_Quality_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("rtd_Quality_r16", -1);

         rtd_Quality_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rtd_Quality_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("rtd_Quality_r16");
