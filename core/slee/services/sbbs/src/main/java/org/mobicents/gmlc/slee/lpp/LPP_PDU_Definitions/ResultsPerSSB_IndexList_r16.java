...
public class ResultsPerSSB_IndexList_r16 extends Asn1SeqOf {
   ...
   protected ResultsPerSSB_Index_r16[] elements;
   ...
   public ResultsPerSSB_IndexList_r16 (int numRecords) {
      elements = new ResultsPerSSB_Index_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultsPerSSB_IndexList_r16 (ResultsPerSSB_Index_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ResultsPerSSB_IndexList_r16) ) return false;
      ResultsPerSSB_IndexList_r16 rhs = (ResultsPerSSB_IndexList_r16) obj;
      ResultsPerSSB_Index_r16[] rhsElements = rhs.elements;
    ...
    */
   public ResultsPerSSB_Index_r16[] getElements () {
      return elements;
   }
   public void setElements (ResultsPerSSB_Index_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultsPerSSB_Index_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultsPerSSB_Index_r16();
