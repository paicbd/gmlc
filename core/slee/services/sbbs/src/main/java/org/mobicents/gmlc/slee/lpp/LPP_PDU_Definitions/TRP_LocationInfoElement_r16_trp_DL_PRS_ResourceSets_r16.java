...
public class TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16 extends Asn1SeqOf {
   ...
   protected DL_PRS_ResourceSets_TRP_Element_r16[] elements;

   public TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16 (int numRecords) {
      elements = new DL_PRS_ResourceSets_TRP_Element_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16 (DL_PRS_ResourceSets_TRP_Element_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16) ) return false;
      TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16 rhs = (TRP_LocationInfoElement_r16_trp_DL_PRS_ResourceSets_r16) obj;
      DL_PRS_ResourceSets_TRP_Element_r16[] rhsElements = rhs.elements;
    ...
    */
   public DL_PRS_ResourceSets_TRP_Element_r16[] getElements () {
      return elements;
   }
   public void setElements (DL_PRS_ResourceSets_TRP_Element_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DL_PRS_ResourceSets_TRP_Element_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DL_PRS_ResourceSets_TRP_Element_r16();
