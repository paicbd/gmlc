...
public class GNSS_AcquisitionAssistList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-AcquisitionAssistList";
   }

   protected GNSS_AcquisitionAssistElement[] elements;
    ...
    * populated.
    */
   public GNSS_AcquisitionAssistList (int numRecords) {
      elements = new GNSS_AcquisitionAssistElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_AcquisitionAssistList (GNSS_AcquisitionAssistElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_AcquisitionAssistList) ) return false;
      GNSS_AcquisitionAssistList rhs = (GNSS_AcquisitionAssistList) obj;
      GNSS_AcquisitionAssistElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_AcquisitionAssistElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_AcquisitionAssistElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_AcquisitionAssistElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_AcquisitionAssistElement();
