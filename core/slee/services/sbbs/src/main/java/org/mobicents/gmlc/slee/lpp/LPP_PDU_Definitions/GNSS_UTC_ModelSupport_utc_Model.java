...
public class GNSS_UTC_ModelSupport_utc_Model extends Asn1BitString {
    ...
    */
   public GNSS_UTC_ModelSupport_utc_Model () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public GNSS_UTC_ModelSupport_utc_Model (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public GNSS_UTC_ModelSupport_utc_Model (int numbits_, byte[] data) 
    ...
    */
   public GNSS_UTC_ModelSupport_utc_Model (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public GNSS_UTC_ModelSupport_utc_Model (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public GNSS_UTC_ModelSupport_utc_Model (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
