...
public class SatelliteInfo extends Asn1SeqOf {
   ...
   protected SatelliteInfoElement[] elements;
    ...
    * populated.
    */
   public SatelliteInfo (int numRecords) {
      elements = new SatelliteInfoElement [numRecords];
   }
    ...
    * given the array.  
    */
   public SatelliteInfo (SatelliteInfoElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SatelliteInfo) ) return false;
      SatelliteInfo rhs = (SatelliteInfo) obj;
      SatelliteInfoElement[] rhsElements = rhs.elements;
    ...
    */
   public SatelliteInfoElement[] getElements () {
      return elements;
   }
   public void setElements (SatelliteInfoElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SatelliteInfoElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SatelliteInfoElement();
