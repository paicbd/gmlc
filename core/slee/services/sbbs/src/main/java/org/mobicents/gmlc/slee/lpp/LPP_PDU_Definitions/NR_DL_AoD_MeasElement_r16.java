...
public class NR_DL_AoD_MeasElement_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "NR-DL-AoD-MeasElement-r16";
   }
   ...
   protected Asn1Integer nr_DL_PRS_RSRP_Result_r16;
   protected Asn1Integer nr_DL_PRS_RxBeamIndex_r16;  // optional
   protected NR_DL_AoD_AdditionalMeasurements_r16 nr_DL_AoD_AdditionalMeasurements_r16;  // optional
   protected Asn1OpenExt extElem1;

   public NR_DL_AoD_MeasElement_r16 () {
      super();
      init();
   }
   ...
   public NR_DL_AoD_MeasElement_r16 (
      ...
      Asn1Integer nr_DL_PRS_RxBeamIndex_r16_,
      NR_DL_AoD_AdditionalMeasurements_r16 nr_DL_AoD_AdditionalMeasurements_r16_
      ...
      setNr_DL_PRS_RxBeamIndex_r16 (nr_DL_PRS_RxBeamIndex_r16_);
      setNr_DL_AoD_AdditionalMeasurements_r16 (nr_DL_AoD_AdditionalMeasurements_r16_);
   }
    ...
    * the given objects 
    */
   public NR_DL_AoD_MeasElement_r16 (long dl_PRS_ID_r16_,
      ...
      long nr_DL_PRS_RxBeamIndex_r16_,
      NR_DL_AoD_AdditionalMeasurements_r16 nr_DL_AoD_AdditionalMeasurements_r16_
   ) throws Asn1Exception {
      super();
      setDl_PRS_ID_r16 (dl_PRS_ID_r16_);
   ...
   public void init () {
      ...
      nr_DL_PRS_RxBeamIndex_r16 = null;
      nr_DL_AoD_AdditionalMeasurements_r16 = null;
      extElem1 = null;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof NR_DL_AoD_MeasElement_r16) ) return false;

      NR_DL_AoD_MeasElement_r16 rhs = (NR_DL_AoD_MeasElement_r16) obj;
      ...
      if (nr_DL_PRS_RxBeamIndex_r16 == null) {
         if (rhs.nr_DL_PRS_RxBeamIndex_r16 != null) return false;
      }
      else {
         if (!nr_DL_PRS_RxBeamIndex_r16.equals(rhs.nr_DL_PRS_RxBeamIndex_r16)) {
            return false;
         }
      }

      if (nr_DL_AoD_AdditionalMeasurements_r16 == null) {
         if (rhs.nr_DL_AoD_AdditionalMeasurements_r16 != null) return false;
      }
      else {
         if (!nr_DL_AoD_AdditionalMeasurements_r16.equals(rhs.nr_DL_AoD_AdditionalMeasurements_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (nr_DL_PRS_RxBeamIndex_r16 != null) __code = 31*__code + nr_DL_PRS_RxBeamIndex_r16.hashCode();
      if (nr_DL_AoD_AdditionalMeasurements_r16 != null) __code = 31*__code + nr_DL_AoD_AdditionalMeasurements_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for Nr_DL_PRS_RxBeamIndex_r16
    */
   public Asn1Integer getNr_DL_PRS_RxBeamIndex_r16 () {
      return nr_DL_PRS_RxBeamIndex_r16;
   }

   public void setNr_DL_PRS_RxBeamIndex_r16 (Asn1Integer value) 
      throws Asn1Exception
   {
      ...
      this.nr_DL_PRS_RxBeamIndex_r16 = value;
   }

   public void setNr_DL_PRS_RxBeamIndex_r16 (long value) 
      throws Asn1Exception
   {
      setNr_DL_PRS_RxBeamIndex_r16 (new Asn1Integer(value));
   }
   public boolean hasNr_DL_PRS_RxBeamIndex_r16 () {
      return (nr_DL_PRS_RxBeamIndex_r16 != null);
   }

   /**
    * Accessor/mutator methods for Nr_DL_AoD_AdditionalMeasurements_r16
    */
   public NR_DL_AoD_AdditionalMeasurements_r16 getNr_DL_AoD_AdditionalMeasurements_r16 () {
      return nr_DL_AoD_AdditionalMeasurements_r16;
   }

   public void setNr_DL_AoD_AdditionalMeasurements_r16 (NR_DL_AoD_AdditionalMeasurements_r16 value) 
      throws Asn1Exception
   {
      if (!((value.getElements().length >= 1 && value.getElements().length <= 7))) {
         throw new Asn1ConsVioException ("value.getElements().length", value.getElements().length);
      }

      this.nr_DL_AoD_AdditionalMeasurements_r16 = value;
   }

   public boolean hasNr_DL_AoD_AdditionalMeasurements_r16 () {
      return (nr_DL_AoD_AdditionalMeasurements_r16 != null);
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 7: return nr_DL_PRS_RSRP_Result_r16;
         case 8: return nr_DL_PRS_RxBeamIndex_r16;
         case 9: return nr_DL_AoD_AdditionalMeasurements_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 7: return "nr-DL-PRS-RSRP-Result-r16";
         case 8: return "nr-DL-PRS-RxBeamIndex-r16";
         case 9: return "nr-DL-AoD-AdditionalMeasurements-r16";
         case 10: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean nr_DL_PRS_RxBeamIndex_r16Present = buffer.decodeBit ("nr_DL_PRS_RxBeamIndex_r16Present");
      boolean nr_DL_AoD_AdditionalMeasurements_r16Present = buffer.decodeBit ("nr_DL_AoD_AdditionalMeasurements_r16Present");
      ...
      // decode nr_DL_PRS_RxBeamIndex_r16

      if (nr_DL_PRS_RxBeamIndex_r16Present) {
         buffer.getContext().eventDispatcher.startElement("nr_DL_PRS_RxBeamIndex_r16", -1);

         nr_DL_PRS_RxBeamIndex_r16 = new Asn1Integer();
         nr_DL_PRS_RxBeamIndex_r16.decode (buffer, 1, 8);
         buffer.getContext().eventDispatcher.endElement("nr_DL_PRS_RxBeamIndex_r16", -1);
      }
      else {
         nr_DL_PRS_RxBeamIndex_r16 = null;
      }

      // decode nr_DL_AoD_AdditionalMeasurements_r16

      if (nr_DL_AoD_AdditionalMeasurements_r16Present) {
         buffer.getContext().eventDispatcher.startElement("nr_DL_AoD_AdditionalMeasurements_r16", -1);

         nr_DL_AoD_AdditionalMeasurements_r16 = new NR_DL_AoD_AdditionalMeasurements_r16();
         nr_DL_AoD_AdditionalMeasurements_r16.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("nr_DL_AoD_AdditionalMeasurements_r16", -1);
      }
      else {
         nr_DL_AoD_AdditionalMeasurements_r16 = null;
      }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((nr_DL_PRS_RxBeamIndex_r16 != null), null);
      buffer.encodeBit ((nr_DL_AoD_AdditionalMeasurements_r16 != null), null);
      ...
      else throw new Asn1MissingRequiredException ("nr_DL_PRS_RSRP_Result_r16");

      // encode nr_DL_PRS_RxBeamIndex_r16

      if (nr_DL_PRS_RxBeamIndex_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("nr_DL_PRS_RxBeamIndex_r16", -1);

         nr_DL_PRS_RxBeamIndex_r16.encode (buffer, 1, 8);

         buffer.getContext().eventDispatcher.endElement("nr_DL_PRS_RxBeamIndex_r16", -1);
      }

      // encode nr_DL_AoD_AdditionalMeasurements_r16

      if (nr_DL_AoD_AdditionalMeasurements_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("nr_DL_AoD_AdditionalMeasurements_r16", -1);

         nr_DL_AoD_AdditionalMeasurements_r16.encode (buffer);
