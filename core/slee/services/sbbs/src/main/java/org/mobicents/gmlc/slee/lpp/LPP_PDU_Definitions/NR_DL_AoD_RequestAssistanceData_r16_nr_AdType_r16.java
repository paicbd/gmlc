...
public class NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 extends Asn1BitString {
    ...
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 (int numbits_, byte[] data) 
    ...
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public NR_DL_AoD_RequestAssistanceData_r16_nr_AdType_r16 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
