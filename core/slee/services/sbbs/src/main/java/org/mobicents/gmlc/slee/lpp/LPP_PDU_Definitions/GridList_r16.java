...
public class GridList_r16 extends Asn1SeqOf {
   ...
   protected GridElement_r16[] elements;
    ...
    * populated.
    */
   public GridList_r16 (int numRecords) {
      elements = new GridElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public GridList_r16 (GridElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GridList_r16) ) return false;
      GridList_r16 rhs = (GridList_r16) obj;
      GridElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public GridElement_r16[] getElements () {
      return elements;
   }
   public void setElements (GridElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GridElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GridElement_r16();
