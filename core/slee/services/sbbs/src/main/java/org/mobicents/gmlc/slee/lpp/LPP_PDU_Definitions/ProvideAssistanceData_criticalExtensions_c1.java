...
public class ProvideAssistanceData_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _PROVIDEASSISTANCEDATA_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ProvideAssistanceData_criticalExtensions_c1 () {
      super();
   }

   public ProvideAssistanceData_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _PROVIDEASSISTANCEDATA_R9: return "provideAssistanceData_r9";
   ...
   /**
    * Accessor/mutator methods for provideAssistanceData_r9
    */
   public ProvideAssistanceData_r9_IEs getProvideAssistanceData_r9 () {
      return (choiceID == _PROVIDEASSISTANCEDATA_R9) ? (ProvideAssistanceData_r9_IEs)element : null;
   }
   public void setProvideAssistanceData_r9 (ProvideAssistanceData_r9_IEs value) {
      setElement (_PROVIDEASSISTANCEDATA_R9, value);
   }
   public boolean isProvideAssistanceData_r9 () {
      return (choiceID == _PROVIDEASSISTANCEDATA_R9);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = provideAssistanceData_r9 = new ProvideAssistanceData_r9_IEs();
            provideAssistanceData_r9.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // provideAssistanceData_r9
         case _PROVIDEASSISTANCEDATA_R9:
            ProvideAssistanceData_r9_IEs provideAssistanceData_r9 = (ProvideAssistanceData_r9_IEs) element;
            provideAssistanceData_r9.encode (buffer);
            break;
