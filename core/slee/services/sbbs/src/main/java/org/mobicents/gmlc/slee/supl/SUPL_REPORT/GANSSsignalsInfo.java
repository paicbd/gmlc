...
public class GANSSsignalsInfo extends Asn1SeqOf {
   ...
   protected GANSSSignalsDescription[] elements;
    ...
    * populated.
    */
   public GANSSsignalsInfo (int numRecords) {
      elements = new GANSSSignalsDescription [numRecords];
   }
    ...
    * given the array.  
    */
   public GANSSsignalsInfo (GANSSSignalsDescription[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GANSSsignalsInfo) ) return false;
      GANSSsignalsInfo rhs = (GANSSsignalsInfo) obj;
      GANSSSignalsDescription[] rhsElements = rhs.elements;
    ...
    */
   public GANSSSignalsDescription[] getElements () {
      return elements;
   }
   public void setElements (GANSSSignalsDescription[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GANSSSignalsDescription [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GANSSSignalsDescription();
