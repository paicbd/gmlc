...
public class ECID_RequestLocationInformation_requestedMeasurements extends Asn1BitString {
   ...
   public final static int rsrpReq = 0;
   public final static int rsrqReq = 1;
   public final static int ueRxTxReq = 2;
   public final static int nrsrpReq_r14 = 3;
   public final static int nrsrqReq_r14 = 4;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public ECID_RequestLocationInformation_requestedMeasurements () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public ECID_RequestLocationInformation_requestedMeasurements (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ECID_RequestLocationInformation_requestedMeasurements (int numbits_, byte[] data) 
    ...
    */
   public ECID_RequestLocationInformation_requestedMeasurements (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public ECID_RequestLocationInformation_requestedMeasurements (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public ECID_RequestLocationInformation_requestedMeasurements (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
