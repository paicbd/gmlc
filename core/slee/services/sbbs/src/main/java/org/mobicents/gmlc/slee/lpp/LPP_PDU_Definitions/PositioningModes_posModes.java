...
public class PositioningModes_posModes extends Asn1BitString {
    ...
    */
   public PositioningModes_posModes (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public PositioningModes_posModes (int numbits_, byte[] data) 
    ...
    */
   public PositioningModes_posModes (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public PositioningModes_posModes (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public PositioningModes_posModes (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
