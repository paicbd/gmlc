...
public class OTDOA_NeighbourCellInfoList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "OTDOA-NeighbourCellInfoList";
   }

   protected OTDOA_NeighbourFreqInfo[] elements;
    ...
    * populated.
    */
   public OTDOA_NeighbourCellInfoList (int numRecords) {
      elements = new OTDOA_NeighbourFreqInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOA_NeighbourCellInfoList (OTDOA_NeighbourFreqInfo[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_NeighbourCellInfoList) ) return false;
      OTDOA_NeighbourCellInfoList rhs = (OTDOA_NeighbourCellInfoList) obj;
      OTDOA_NeighbourFreqInfo[] rhsElements = rhs.elements;
    ...
    */
   public OTDOA_NeighbourFreqInfo[] getElements () {
      return elements;
   }
   public void setElements (OTDOA_NeighbourFreqInfo[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OTDOA_NeighbourFreqInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OTDOA_NeighbourFreqInfo();
