...
public class ServingCellInformationNR extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServingCellInformationNR";
   }

   protected ServCellNR[] elements;

   public ServingCellInformationNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellInformationNR (int numRecords) {
      elements = new ServCellNR [numRecords];
   }
    ...
    * given the array.  
    */
   public ServingCellInformationNR (ServCellNR[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ServingCellInformationNR) ) return false;
      ServingCellInformationNR rhs = (ServingCellInformationNR) obj;
      ServCellNR[] rhsElements = rhs.elements;
    ...
    */
   public ServCellNR[] getElements () {
      return elements;
   }
   public void setElements (ServCellNR[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServCellNR [numElements];
