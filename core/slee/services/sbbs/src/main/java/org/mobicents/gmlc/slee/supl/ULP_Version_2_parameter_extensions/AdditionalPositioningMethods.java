...
public class AdditionalPositioningMethods extends Asn1SeqOf {
   ...
   protected AddPosSupport_Element[] elements;

   public AdditionalPositioningMethods () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalPositioningMethods (int numRecords) {
      elements = new AddPosSupport_Element [numRecords];
   }
    ...
    * given the array.  
    */
   public AdditionalPositioningMethods (AddPosSupport_Element[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AdditionalPositioningMethods) ) return false;
      AdditionalPositioningMethods rhs = (AdditionalPositioningMethods) obj;
      AddPosSupport_Element[] rhsElements = rhs.elements;
    ...
    */
   public AddPosSupport_Element[] getElements () {
      return elements;
   }
   public void setElements (AddPosSupport_Element[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AddPosSupport_Element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AddPosSupport_Element();
