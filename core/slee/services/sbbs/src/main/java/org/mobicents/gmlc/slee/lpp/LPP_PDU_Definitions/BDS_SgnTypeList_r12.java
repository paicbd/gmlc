...
public class BDS_SgnTypeList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BDS-SgnTypeList-r12";
   }

   protected BDS_SgnTypeElement_r12[] elements;
    ...
    * populated.
    */
   public BDS_SgnTypeList_r12 (int numRecords) {
      elements = new BDS_SgnTypeElement_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public BDS_SgnTypeList_r12 (BDS_SgnTypeElement_r12[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof BDS_SgnTypeList_r12) ) return false;
      BDS_SgnTypeList_r12 rhs = (BDS_SgnTypeList_r12) obj;
      BDS_SgnTypeElement_r12[] rhsElements = rhs.elements;
    ...
    */
   public BDS_SgnTypeElement_r12[] getElements () {
      return elements;
   }
   public void setElements (BDS_SgnTypeElement_r12[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BDS_SgnTypeElement_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BDS_SgnTypeElement_r12();
