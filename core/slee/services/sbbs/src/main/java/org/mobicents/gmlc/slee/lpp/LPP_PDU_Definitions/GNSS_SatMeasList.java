...
public class GNSS_SatMeasList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-SatMeasList";
   }

   protected GNSS_SatMeasElement[] elements;
    ...
    * populated.
    */
   public GNSS_SatMeasList (int numRecords) {
      elements = new GNSS_SatMeasElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_SatMeasList (GNSS_SatMeasElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_SatMeasList) ) return false;
      GNSS_SatMeasList rhs = (GNSS_SatMeasList) obj;
      GNSS_SatMeasElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_SatMeasElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_SatMeasElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_SatMeasElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_SatMeasElement();
