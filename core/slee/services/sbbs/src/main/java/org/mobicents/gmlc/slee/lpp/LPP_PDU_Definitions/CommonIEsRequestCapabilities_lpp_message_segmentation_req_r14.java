...
public class CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 extends Asn1BitString {
   ...
   public final static int serverToTarget = 0;
   public final static int targetToServer = 1;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 (int numbits_, byte[] data) {
      super (numbits_, data);
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 (boolean[] bitValues) {
      super (bitValues);
      trimZeroBits = true;
   }
    ...
    *
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 (String value_) throws Asn1ValueParseException {
      super (value_);
      trimZeroBits = true;
   }
    ...
    */
   public CommonIEsRequestCapabilities_lpp_message_segmentation_req_r14 (java.util.BitSet bitSet) {
      super (bitSet);
      trimZeroBits = true;
   }
