...
public class SessionList extends Asn1SeqOf {
   ...
   protected SessionInformation[] elements;
    ...
    * populated.
    */
   public SessionList (int numRecords) {
      elements = new SessionInformation [numRecords];
   }
    ...
    * given the array.  
    */
   public SessionList (SessionInformation[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof SessionList) ) return false;
      SessionList rhs = (SessionList) obj;
      SessionInformation[] rhsElements = rhs.elements;
    ...
    */
   public SessionInformation[] getElements () {
      return elements;
   }
   public void setElements (SessionInformation[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SessionInformation [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SessionInformation();
