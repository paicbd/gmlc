...
public class GanssRequestedGenericAssistanceDataList extends Asn1SeqOf {
   ...
   protected GanssReqGenericData[] elements;
    ...
    * populated.
    */
   public GanssRequestedGenericAssistanceDataList (int numRecords) {
      elements = new GanssReqGenericData [numRecords];
   }
    ...
    * given the array.  
    */
   public GanssRequestedGenericAssistanceDataList (GanssReqGenericData[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GanssRequestedGenericAssistanceDataList) ) return false;
      GanssRequestedGenericAssistanceDataList rhs = (GanssRequestedGenericAssistanceDataList) obj;
      GanssReqGenericData[] rhsElements = rhs.elements;
    ...
    */
   public GanssReqGenericData[] getElements () {
      return elements;
   }
   public void setElements (GanssReqGenericData[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GanssReqGenericData [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GanssReqGenericData();
