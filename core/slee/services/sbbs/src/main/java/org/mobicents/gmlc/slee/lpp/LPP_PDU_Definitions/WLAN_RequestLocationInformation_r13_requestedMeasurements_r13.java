...
public class WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 extends Asn1BitString {
    ...
    */
   public WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 (int numbits_, byte[] data) 
    ...
    */
   public WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public WLAN_RequestLocationInformation_r13_requestedMeasurements_r13 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
