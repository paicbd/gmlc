...
public class OTDOA_NeighbourCellInfoListNB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "OTDOA-NeighbourCellInfoListNB-r14";
   }

   protected OTDOA_NeighbourCellInfoNB_r14[] elements;

   public OTDOA_NeighbourCellInfoListNB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOA_NeighbourCellInfoListNB_r14 (int numRecords) {
      elements = new OTDOA_NeighbourCellInfoNB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOA_NeighbourCellInfoListNB_r14 (OTDOA_NeighbourCellInfoNB_r14[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OTDOA_NeighbourCellInfoListNB_r14) ) return false;
      OTDOA_NeighbourCellInfoListNB_r14 rhs = (OTDOA_NeighbourCellInfoListNB_r14) obj;
      OTDOA_NeighbourCellInfoNB_r14[] rhsElements = rhs.elements;
    ...
    */
   public OTDOA_NeighbourCellInfoNB_r14[] getElements () {
      return elements;
   }
   public void setElements (OTDOA_NeighbourCellInfoNB_r14[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OTDOA_NeighbourCellInfoNB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OTDOA_NeighbourCellInfoNB_r14();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 72);
