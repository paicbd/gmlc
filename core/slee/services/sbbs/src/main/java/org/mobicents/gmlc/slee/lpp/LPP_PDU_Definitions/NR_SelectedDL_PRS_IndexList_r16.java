...
public class NR_SelectedDL_PRS_IndexList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NR-SelectedDL-PRS-IndexList-r16";
   }

   protected NR_SelectedDL_PRS_PerFreq_r16[] elements;

   public NR_SelectedDL_PRS_IndexList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_SelectedDL_PRS_IndexList_r16 (int numRecords) {
      elements = new NR_SelectedDL_PRS_PerFreq_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_SelectedDL_PRS_IndexList_r16 (NR_SelectedDL_PRS_PerFreq_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_SelectedDL_PRS_IndexList_r16) ) return false;
      NR_SelectedDL_PRS_IndexList_r16 rhs = (NR_SelectedDL_PRS_IndexList_r16) obj;
      NR_SelectedDL_PRS_PerFreq_r16[] rhsElements = rhs.elements;
    ...
    */
   public NR_SelectedDL_PRS_PerFreq_r16[] getElements () {
      return elements;
   }
   public void setElements (NR_SelectedDL_PRS_PerFreq_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_SelectedDL_PRS_PerFreq_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_SelectedDL_PRS_PerFreq_r16();
