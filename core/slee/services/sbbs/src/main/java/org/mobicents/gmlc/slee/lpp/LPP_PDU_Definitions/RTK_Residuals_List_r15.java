...
public class RTK_Residuals_List_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RTK-Residuals-List-r15";
   }

   protected RTK_Residuals_Element_r15[] elements;

   public RTK_Residuals_List_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RTK_Residuals_List_r15 (int numRecords) {
      elements = new RTK_Residuals_Element_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public RTK_Residuals_List_r15 (RTK_Residuals_Element_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RTK_Residuals_List_r15) ) return false;
      RTK_Residuals_List_r15 rhs = (RTK_Residuals_List_r15) obj;
      RTK_Residuals_Element_r15[] rhsElements = rhs.elements;
    ...
    */
   public RTK_Residuals_Element_r15[] getElements () {
      return elements;
   }
   public void setElements (RTK_Residuals_Element_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RTK_Residuals_Element_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RTK_Residuals_Element_r15();
