...
public class STEC_SatList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "STEC-SatList-r16";
   }

   protected STEC_SatElement_r16[] elements;

   public STEC_SatList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public STEC_SatList_r16 (int numRecords) {
      elements = new STEC_SatElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public STEC_SatList_r16 (STEC_SatElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof STEC_SatList_r16) ) return false;
      STEC_SatList_r16 rhs = (STEC_SatList_r16) obj;
      STEC_SatElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public STEC_SatElement_r16[] getElements () {
      return elements;
   }
   public void setElements (STEC_SatElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new STEC_SatElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new STEC_SatElement_r16();
