...
public class ProvideLocationInformation extends Asn1Seq {
   ...
   protected ProvideLocationInformation_criticalExtensions criticalExtensions;
    ...
    */
   public ProvideLocationInformation (
      ProvideLocationInformation_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ProvideLocationInformation) ) return false;

      ProvideLocationInformation rhs = (ProvideLocationInformation) obj;
    ...
    */
   public ProvideLocationInformation_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (ProvideLocationInformation_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ProvideLocationInformation_criticalExtensions();
