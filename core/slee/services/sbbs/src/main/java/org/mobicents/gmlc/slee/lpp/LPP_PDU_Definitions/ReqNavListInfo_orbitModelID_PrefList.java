...
public class ReqNavListInfo_orbitModelID_PrefList extends Asn1SeqOf {
   ...
   public ReqNavListInfo_orbitModelID_PrefList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReqNavListInfo_orbitModelID_PrefList (int numRecords) {
    ...
    * given the array.  
    */
   public ReqNavListInfo_orbitModelID_PrefList (Asn1Integer[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ReqNavListInfo_orbitModelID_PrefList) ) return false;
      ReqNavListInfo_orbitModelID_PrefList rhs = (ReqNavListInfo_orbitModelID_PrefList) obj;
