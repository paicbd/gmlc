...
public class NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16 extends Asn1SeqOf {
   ...
   protected NR_SSB_Config_r16[] elements;

   public NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16 (int numRecords) {
      elements = new NR_SSB_Config_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16 (NR_SSB_Config_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16) ) return false;
      NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16 rhs = (NR_DL_PRS_AssistanceData_r16_nr_SSB_Config_r16) obj;
      NR_SSB_Config_r16[] rhsElements = rhs.elements;
    ...
    */
   public NR_SSB_Config_r16[] getElements () {
      return elements;
   }
   public void setElements (NR_SSB_Config_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_SSB_Config_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_SSB_Config_r16();
