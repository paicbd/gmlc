...
public class ProvideLocationInformation_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _PROVIDELOCATIONINFORMATION_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ProvideLocationInformation_criticalExtensions_c1 () {
      super();
   }

   public ProvideLocationInformation_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _PROVIDELOCATIONINFORMATION_R9: return "provideLocationInformation_r9";
   ...
   /**
    * Accessor/mutator methods for provideLocationInformation_r9
    */
   public ProvideLocationInformation_r9_IEs getProvideLocationInformation_r9 () {
      return (choiceID == _PROVIDELOCATIONINFORMATION_R9) ? (ProvideLocationInformation_r9_IEs)element : null;
   }
   public void setProvideLocationInformation_r9 (ProvideLocationInformation_r9_IEs value) {
      setElement (_PROVIDELOCATIONINFORMATION_R9, value);
   }
   public boolean isProvideLocationInformation_r9 () {
      return (choiceID == _PROVIDELOCATIONINFORMATION_R9);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = provideLocationInformation_r9 = new ProvideLocationInformation_r9_IEs();
            provideLocationInformation_r9.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // provideLocationInformation_r9
         case _PROVIDELOCATIONINFORMATION_R9:
            ProvideLocationInformation_r9_IEs provideLocationInformation_r9 = (ProvideLocationInformation_r9_IEs) element;
            provideLocationInformation_r9.encode (buffer);
            break;
