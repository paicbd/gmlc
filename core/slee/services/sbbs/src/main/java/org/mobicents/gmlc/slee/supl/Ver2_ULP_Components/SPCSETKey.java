...
public class SPCSETKey extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public SPCSETKey (int numbits_, byte[] data) 
    ...
    */
   public SPCSETKey (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!(getLength() == 128)) {
    ...
    *
    */
   public SPCSETKey (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!(getLength() == 128)) {
    ...
    */
   public SPCSETKey (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!(getLength() == 128)) {
