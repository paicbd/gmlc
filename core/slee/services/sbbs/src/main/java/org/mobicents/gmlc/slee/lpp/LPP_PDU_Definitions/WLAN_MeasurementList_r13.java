...
public class WLAN_MeasurementList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-MeasurementList-r13";
   }

   protected WLAN_MeasurementElement_r13[] elements;
    ...
    * populated.
    */
   public WLAN_MeasurementList_r13 (int numRecords) {
      elements = new WLAN_MeasurementElement_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_MeasurementList_r13 (WLAN_MeasurementElement_r13[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof WLAN_MeasurementList_r13) ) return false;
      WLAN_MeasurementList_r13 rhs = (WLAN_MeasurementList_r13) obj;
      WLAN_MeasurementElement_r13[] rhsElements = rhs.elements;
    ...
    */
   public WLAN_MeasurementElement_r13[] getElements () {
      return elements;
   }
   public void setElements (WLAN_MeasurementElement_r13[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_MeasurementElement_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_MeasurementElement_r13();
