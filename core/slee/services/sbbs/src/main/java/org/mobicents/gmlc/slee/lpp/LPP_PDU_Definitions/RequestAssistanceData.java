...
public class RequestAssistanceData extends Asn1Seq {
   ...
   protected RequestAssistanceData_criticalExtensions criticalExtensions;
    ...
    */
   public RequestAssistanceData (
      RequestAssistanceData_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RequestAssistanceData) ) return false;

      RequestAssistanceData rhs = (RequestAssistanceData) obj;
    ...
    */
   public RequestAssistanceData_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (RequestAssistanceData_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RequestAssistanceData_criticalExtensions();
