...
public class RTD_InfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RTD-InfoList-r16";
   }

   protected RTD_InfoListPerFreqLayer_r16[] elements;

   public RTD_InfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RTD_InfoList_r16 (int numRecords) {
      elements = new RTD_InfoListPerFreqLayer_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public RTD_InfoList_r16 (RTD_InfoListPerFreqLayer_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof RTD_InfoList_r16) ) return false;
      RTD_InfoList_r16 rhs = (RTD_InfoList_r16) obj;
      RTD_InfoListPerFreqLayer_r16[] rhsElements = rhs.elements;
    ...
    */
   public RTD_InfoListPerFreqLayer_r16[] getElements () {
      return elements;
   }
   public void setElements (RTD_InfoListPerFreqLayer_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RTD_InfoListPerFreqLayer_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RTD_InfoListPerFreqLayer_r16();
