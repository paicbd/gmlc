...
public class GNSS_ID_GLONASS extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-ID-GLONASS";
   }

   protected GNSS_ID_GLONASS_SatElement[] elements;
    ...
    * populated.
    */
   public GNSS_ID_GLONASS (int numRecords) {
      elements = new GNSS_ID_GLONASS_SatElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_ID_GLONASS (GNSS_ID_GLONASS_SatElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_ID_GLONASS) ) return false;
      GNSS_ID_GLONASS rhs = (GNSS_ID_GLONASS) obj;
      GNSS_ID_GLONASS_SatElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_ID_GLONASS_SatElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_ID_GLONASS_SatElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_ID_GLONASS_SatElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_ID_GLONASS_SatElement();
