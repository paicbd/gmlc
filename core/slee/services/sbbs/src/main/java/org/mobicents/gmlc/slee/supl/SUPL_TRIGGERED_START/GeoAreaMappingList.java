...
public class GeoAreaMappingList extends Asn1SeqOf {
   ...
   protected GeoAreaIndex[] elements;
    ...
    * populated.
    */
   public GeoAreaMappingList (int numRecords) {
      elements = new GeoAreaIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public GeoAreaMappingList (GeoAreaIndex[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GeoAreaMappingList) ) return false;
      GeoAreaMappingList rhs = (GeoAreaMappingList) obj;
      GeoAreaIndex[] rhsElements = rhs.elements;
    ...
    */
   public GeoAreaIndex[] getElements () {
      return elements;
   }
   public void setElements (GeoAreaIndex[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GeoAreaIndex [numElements];
