...
public class MeasuredResultsList extends Asn1SeqOf {
   ...
   protected MeasuredResults[] elements;
   ...
   public MeasuredResultsList (int numRecords) {
      elements = new MeasuredResults [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasuredResultsList (MeasuredResults[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      MeasuredResults[] rhsElements = rhs.elements;
    ...
    */
   public MeasuredResults[] getElements () {
      return elements;
   }
   public void setElements (MeasuredResults[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasuredResults [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasuredResults();
