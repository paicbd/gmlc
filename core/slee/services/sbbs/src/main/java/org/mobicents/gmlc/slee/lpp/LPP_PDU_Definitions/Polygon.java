...
public class Polygon extends Asn1SeqOf {
   ...
   protected PolygonPoints[] elements;
    ...
    * populated.
    */
   public Polygon (int numRecords) {
      elements = new PolygonPoints [numRecords];
   }
    ...
    * given the array.  
    */
   public Polygon (PolygonPoints[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      PolygonPoints[] rhsElements = rhs.elements;
    ...
    */
   public PolygonPoints[] getElements () {
      return elements;
   }
   public void setElements (PolygonPoints[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PolygonPoints [numElements];
