...
public class GNSS_DataBitsReqSatList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-DataBitsReqSatList";
   }

   protected GNSS_DataBitsReqSatElement[] elements;
    ...
    * populated.
    */
   public GNSS_DataBitsReqSatList (int numRecords) {
      elements = new GNSS_DataBitsReqSatElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_DataBitsReqSatList (GNSS_DataBitsReqSatElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_DataBitsReqSatList) ) return false;
      GNSS_DataBitsReqSatList rhs = (GNSS_DataBitsReqSatList) obj;
      GNSS_DataBitsReqSatElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_DataBitsReqSatElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_DataBitsReqSatElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_DataBitsReqSatElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_DataBitsReqSatElement();
