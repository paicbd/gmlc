...
public class GNSS_ID_GPS extends Asn1SeqOf {
   ...
   protected GNSS_ID_GPS_SatElement[] elements;
    ...
    * populated.
    */
   public GNSS_ID_GPS (int numRecords) {
      elements = new GNSS_ID_GPS_SatElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_ID_GPS (GNSS_ID_GPS_SatElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_ID_GPS) ) return false;
      GNSS_ID_GPS rhs = (GNSS_ID_GPS) obj;
      GNSS_ID_GPS_SatElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_ID_GPS_SatElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_ID_GPS_SatElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_ID_GPS_SatElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_ID_GPS_SatElement();
