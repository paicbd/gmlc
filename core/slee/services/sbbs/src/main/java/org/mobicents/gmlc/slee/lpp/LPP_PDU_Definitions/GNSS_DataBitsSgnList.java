...
public class GNSS_DataBitsSgnList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "GNSS-DataBitsSgnList";
   }

   protected GNSS_DataBitsSgnElement[] elements;
    ...
    * populated.
    */
   public GNSS_DataBitsSgnList (int numRecords) {
      elements = new GNSS_DataBitsSgnElement [numRecords];
   }
    ...
    * given the array.  
    */
   public GNSS_DataBitsSgnList (GNSS_DataBitsSgnElement[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GNSS_DataBitsSgnList) ) return false;
      GNSS_DataBitsSgnList rhs = (GNSS_DataBitsSgnList) obj;
      GNSS_DataBitsSgnElement[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_DataBitsSgnElement[] getElements () {
      return elements;
   }
   public void setElements (GNSS_DataBitsSgnElement[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_DataBitsSgnElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_DataBitsSgnElement();
