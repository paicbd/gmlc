...
public class STEC_ResidualSatList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "STEC-ResidualSatList-r16";
   }

   protected STEC_ResidualSatElement_r16[] elements;

   public STEC_ResidualSatList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public STEC_ResidualSatList_r16 (int numRecords) {
      elements = new STEC_ResidualSatElement_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public STEC_ResidualSatList_r16 (STEC_ResidualSatElement_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof STEC_ResidualSatList_r16) ) return false;
      STEC_ResidualSatList_r16 rhs = (STEC_ResidualSatList_r16) obj;
      STEC_ResidualSatElement_r16[] rhsElements = rhs.elements;
    ...
    */
   public STEC_ResidualSatElement_r16[] getElements () {
      return elements;
   }
   public void setElements (STEC_ResidualSatElement_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new STEC_ResidualSatElement_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new STEC_ResidualSatElement_r16();
