...
public class ResultsPerCSI_RS_IndexList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ResultsPerCSI-RS-IndexList-r16";
   }

   protected ResultsPerCSI_RS_Index_r16[] elements;

   public ResultsPerCSI_RS_IndexList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultsPerCSI_RS_IndexList_r16 (int numRecords) {
      elements = new ResultsPerCSI_RS_Index_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultsPerCSI_RS_IndexList_r16 (ResultsPerCSI_RS_Index_r16[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ResultsPerCSI_RS_IndexList_r16) ) return false;
      ResultsPerCSI_RS_IndexList_r16 rhs = (ResultsPerCSI_RS_IndexList_r16) obj;
      ResultsPerCSI_RS_Index_r16[] rhsElements = rhs.elements;
    ...
    */
   public ResultsPerCSI_RS_Index_r16[] getElements () {
      return elements;
   }
   public void setElements (ResultsPerCSI_RS_Index_r16[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultsPerCSI_RS_Index_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultsPerCSI_RS_Index_r16();
