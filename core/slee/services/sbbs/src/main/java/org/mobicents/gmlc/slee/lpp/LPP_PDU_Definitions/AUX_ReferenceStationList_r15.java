...
public class AUX_ReferenceStationList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AUX-ReferenceStationList-r15";
   }

   protected AUX_ReferenceStationID_Element_r15[] elements;

   public AUX_ReferenceStationList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AUX_ReferenceStationList_r15 (int numRecords) {
      elements = new AUX_ReferenceStationID_Element_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public AUX_ReferenceStationList_r15 (AUX_ReferenceStationID_Element_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AUX_ReferenceStationList_r15) ) return false;
      AUX_ReferenceStationList_r15 rhs = (AUX_ReferenceStationList_r15) obj;
      AUX_ReferenceStationID_Element_r15[] rhsElements = rhs.elements;
    ...
    */
   public AUX_ReferenceStationID_Element_r15[] getElements () {
      return elements;
   }
   public void setElements (AUX_ReferenceStationID_Element_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AUX_ReferenceStationID_Element_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AUX_ReferenceStationID_Element_r15();
