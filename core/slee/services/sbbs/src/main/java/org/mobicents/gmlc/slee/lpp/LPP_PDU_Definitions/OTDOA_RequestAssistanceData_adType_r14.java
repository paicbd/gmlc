...
public class OTDOA_RequestAssistanceData_adType_r14 extends Asn1BitString {
    ...
    */
   public OTDOA_RequestAssistanceData_adType_r14 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public OTDOA_RequestAssistanceData_adType_r14 (int numbits_, byte[] data) 
    ...
    */
   public OTDOA_RequestAssistanceData_adType_r14 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public OTDOA_RequestAssistanceData_adType_r14 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public OTDOA_RequestAssistanceData_adType_r14 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
