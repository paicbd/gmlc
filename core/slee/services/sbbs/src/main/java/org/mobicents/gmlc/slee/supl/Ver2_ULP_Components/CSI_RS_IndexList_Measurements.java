...
public class CSI_RS_IndexList_Measurements extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-IndexList-Measurements";
   }

   protected CSI_RS_Index_Measurements[] elements;

   public CSI_RS_IndexList_Measurements () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_IndexList_Measurements (int numRecords) {
      elements = new CSI_RS_Index_Measurements [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_IndexList_Measurements (CSI_RS_Index_Measurements[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof CSI_RS_IndexList_Measurements) ) return false;
      CSI_RS_IndexList_Measurements rhs = (CSI_RS_IndexList_Measurements) obj;
      CSI_RS_Index_Measurements[] rhsElements = rhs.elements;
    ...
    */
   public CSI_RS_Index_Measurements[] getElements () {
      return elements;
   }
   public void setElements (CSI_RS_Index_Measurements[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_RS_Index_Measurements [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_RS_Index_Measurements();
