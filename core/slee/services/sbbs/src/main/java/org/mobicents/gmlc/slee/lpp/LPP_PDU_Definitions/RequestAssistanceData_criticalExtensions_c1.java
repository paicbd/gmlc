...
public class RequestAssistanceData_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _REQUESTASSISTANCEDATA_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public RequestAssistanceData_criticalExtensions_c1 () {
      super();
   }

   public RequestAssistanceData_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _REQUESTASSISTANCEDATA_R9: return "requestAssistanceData_r9";
   ...
   /**
    * Accessor/mutator methods for requestAssistanceData_r9
    */
   public RequestAssistanceData_r9_IEs getRequestAssistanceData_r9 () {
      return (choiceID == _REQUESTASSISTANCEDATA_R9) ? (RequestAssistanceData_r9_IEs)element : null;
   }
   public void setRequestAssistanceData_r9 (RequestAssistanceData_r9_IEs value) {
      setElement (_REQUESTASSISTANCEDATA_R9, value);
   }
   public boolean isRequestAssistanceData_r9 () {
      return (choiceID == _REQUESTASSISTANCEDATA_R9);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = requestAssistanceData_r9 = new RequestAssistanceData_r9_IEs();
            requestAssistanceData_r9.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // requestAssistanceData_r9
         case _REQUESTASSISTANCEDATA_R9:
            RequestAssistanceData_r9_IEs requestAssistanceData_r9 = (RequestAssistanceData_r9_IEs) element;
            requestAssistanceData_r9.encode (buffer);
            break;
