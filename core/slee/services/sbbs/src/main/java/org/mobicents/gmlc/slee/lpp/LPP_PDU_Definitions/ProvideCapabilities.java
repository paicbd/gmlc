...
public class ProvideCapabilities extends Asn1Seq {
   ...
   protected ProvideCapabilities_criticalExtensions criticalExtensions;
    ...
    */
   public ProvideCapabilities (
      ProvideCapabilities_criticalExtensions criticalExtensions_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ProvideCapabilities) ) return false;

      ProvideCapabilities rhs = (ProvideCapabilities) obj;
    ...
    */
   public ProvideCapabilities_criticalExtensions getCriticalExtensions () {
      return criticalExtensions;
   }

   public void setCriticalExtensions (ProvideCapabilities_criticalExtensions value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ProvideCapabilities_criticalExtensions();
