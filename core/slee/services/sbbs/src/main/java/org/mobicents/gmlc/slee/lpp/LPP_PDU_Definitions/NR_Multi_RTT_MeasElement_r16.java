...
public class NR_Multi_RTT_MeasElement_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "NR-Multi-RTT-MeasElement-r16";
   }
   ...
   protected NR_Multi_RTT_MeasElement_r16_nr_UE_RxTxTimeDiff_r16 nr_UE_RxTxTimeDiff_r16;
   ...
   protected NR_Multi_RTT_AdditionalMeasurements_r16 nr_Multi_RTT_AdditionalMeasurements_r16;  // optional
   protected Asn1OpenExt extElem1;

   public NR_Multi_RTT_MeasElement_r16 () {
      super();
      init();
   }
   ...
   public NR_Multi_RTT_MeasElement_r16 (
      ...
      NR_Multi_RTT_MeasElement_r16_nr_UE_RxTxTimeDiff_r16 nr_UE_RxTxTimeDiff_r16_,
      ...
      NR_Multi_RTT_AdditionalMeasurements_r16 nr_Multi_RTT_AdditionalMeasurements_r16_
      ...
      setNr_UE_RxTxTimeDiff_r16 (nr_UE_RxTxTimeDiff_r16_);
      ...
      setNr_Multi_RTT_AdditionalMeasurements_r16 (nr_Multi_RTT_AdditionalMeasurements_r16_);
   }
    ...
    * the given objects 
    */
   public NR_Multi_RTT_MeasElement_r16 (long dl_PRS_ID_r16_,
   ...
   public void init () {
      ...
      nr_UE_RxTxTimeDiff_r16 = null;
      nr_AdditionalPathList_r16 = null;
      nr_TimeStamp_r16 = null;
      nr_TimingQuality_r16 = null;
      nr_DL_PRS_RSRP_Result_r16 = null;
      nr_Multi_RTT_AdditionalMeasurements_r16 = null;
      extElem1 = null;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof NR_Multi_RTT_MeasElement_r16) ) return false;

      NR_Multi_RTT_MeasElement_r16 rhs = (NR_Multi_RTT_MeasElement_r16) obj;
      ...
      if (nr_UE_RxTxTimeDiff_r16 == null) {
         if (rhs.nr_UE_RxTxTimeDiff_r16 != null) return false;
      }
      else {
         if (!nr_UE_RxTxTimeDiff_r16.equals(rhs.nr_UE_RxTxTimeDiff_r16)) {
            return false;
         }
      }
      ...
      if (nr_Multi_RTT_AdditionalMeasurements_r16 == null) {
         if (rhs.nr_Multi_RTT_AdditionalMeasurements_r16 != null) return false;
      }
      else {
         if (!nr_Multi_RTT_AdditionalMeasurements_r16.equals(rhs.nr_Multi_RTT_AdditionalMeasurements_r16)) {
            return false;
         }
      }
   ...
   public int hashCode() {
      ...
      if (nr_UE_RxTxTimeDiff_r16 != null) __code = 31*__code + nr_UE_RxTxTimeDiff_r16.hashCode();
      ...
      if (nr_Multi_RTT_AdditionalMeasurements_r16 != null) __code = 31*__code + nr_Multi_RTT_AdditionalMeasurements_r16.hashCode();
   ...
   /**
    * Accessor/mutator methods for Nr_UE_RxTxTimeDiff_r16
    */
   public NR_Multi_RTT_MeasElement_r16_nr_UE_RxTxTimeDiff_r16 getNr_UE_RxTxTimeDiff_r16 () {
      return nr_UE_RxTxTimeDiff_r16;
   }

   public void setNr_UE_RxTxTimeDiff_r16 (NR_Multi_RTT_MeasElement_r16_nr_UE_RxTxTimeDiff_r16 value) {
      this.nr_UE_RxTxTimeDiff_r16 = value;
   }
   ...
   /**
    * Accessor/mutator methods for Nr_Multi_RTT_AdditionalMeasurements_r16
    */
   public NR_Multi_RTT_AdditionalMeasurements_r16 getNr_Multi_RTT_AdditionalMeasurements_r16 () {
      return nr_Multi_RTT_AdditionalMeasurements_r16;
   }

   public void setNr_Multi_RTT_AdditionalMeasurements_r16 (NR_Multi_RTT_AdditionalMeasurements_r16 value) 
      throws Asn1Exception
   {
      ...
      this.nr_Multi_RTT_AdditionalMeasurements_r16 = value;
   }

   public boolean hasNr_Multi_RTT_AdditionalMeasurements_r16 () {
      return (nr_Multi_RTT_AdditionalMeasurements_r16 != null);
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 6: return nr_UE_RxTxTimeDiff_r16;
         case 7: return nr_AdditionalPathList_r16;
         case 8: return nr_TimeStamp_r16;
         case 9: return nr_TimingQuality_r16;
         case 10: return nr_DL_PRS_RSRP_Result_r16;
         case 11: return nr_Multi_RTT_AdditionalMeasurements_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 6: return "nr-UE-RxTxTimeDiff-r16";
         case 7: return "nr-AdditionalPathList-r16";
         case 8: return "nr-TimeStamp-r16";
         case 9: return "nr-TimingQuality-r16";
         case 10: return "nr-DL-PRS-RSRP-Result-r16";
         case 11: return "nr-Multi-RTT-AdditionalMeasurements-r16";
         case 12: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean nr_Multi_RTT_AdditionalMeasurements_r16Present = buffer.decodeBit ("nr_Multi_RTT_AdditionalMeasurements_r16Present");
      ...
      // decode nr_UE_RxTxTimeDiff_r16

      buffer.getContext().eventDispatcher.startElement("nr_UE_RxTxTimeDiff_r16", -1);

      nr_UE_RxTxTimeDiff_r16 = new NR_Multi_RTT_MeasElement_r16_nr_UE_RxTxTimeDiff_r16();
      nr_UE_RxTxTimeDiff_r16.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("nr_UE_RxTxTimeDiff_r16", -1);
      ...
      // decode nr_Multi_RTT_AdditionalMeasurements_r16

      if (nr_Multi_RTT_AdditionalMeasurements_r16Present) {
         buffer.getContext().eventDispatcher.startElement("nr_Multi_RTT_AdditionalMeasurements_r16", -1);

         nr_Multi_RTT_AdditionalMeasurements_r16 = new NR_Multi_RTT_AdditionalMeasurements_r16();
         nr_Multi_RTT_AdditionalMeasurements_r16.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("nr_Multi_RTT_AdditionalMeasurements_r16", -1);
      }
      else {
         nr_Multi_RTT_AdditionalMeasurements_r16 = null;
      }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((nr_Multi_RTT_AdditionalMeasurements_r16 != null), null);
      ...
      // encode nr_UE_RxTxTimeDiff_r16

      if (nr_UE_RxTxTimeDiff_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("nr_UE_RxTxTimeDiff_r16", -1);

         nr_UE_RxTxTimeDiff_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("nr_UE_RxTxTimeDiff_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("nr_UE_RxTxTimeDiff_r16");
      ...
      // encode nr_Multi_RTT_AdditionalMeasurements_r16

      if (nr_Multi_RTT_AdditionalMeasurements_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("nr_Multi_RTT_AdditionalMeasurements_r16", -1);

         nr_Multi_RTT_AdditionalMeasurements_r16.encode (buffer);
