...
public class Sensor_ProvideCapabilities_r13_sensor_Modes_r13 extends Asn1BitString {
   ...
   public final static int ue_assisted = 1;
   public final static int ue_based = 2;

   /**
    * This constructor creates an empty bit string that can be used in 
    * a decode method call to receive a bit string value.
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 () {
      super();
      value = new byte [1];
      trimZeroBits = true;
   }
    ...
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 (int numbits_, byte[] data) 
    ...
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 (boolean[] bitValues) 
      throws Asn1Exception
   {
      super (bitValues);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    *
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 (String value_) 
      throws Asn1Exception
   {
      super (value_);
      if (!((getLength() >= 1 && getLength() <= 8))) {
    ...
    */
   public Sensor_ProvideCapabilities_r13_sensor_Modes_r13 (java.util.BitSet bitSet) 
      throws Asn1Exception
   {
      super (bitSet);
      if (!((getLength() >= 1 && getLength() <= 8))) {
