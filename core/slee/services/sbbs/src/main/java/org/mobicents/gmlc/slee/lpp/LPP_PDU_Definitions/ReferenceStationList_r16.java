...
public class ReferenceStationList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ReferenceStationList-r16";
   }

   protected GNSS_ReferenceStationID_r15[] elements;

   public ReferenceStationList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReferenceStationList_r16 (int numRecords) {
      elements = new GNSS_ReferenceStationID_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public ReferenceStationList_r16 (GNSS_ReferenceStationID_r15[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ReferenceStationList_r16) ) return false;
      ReferenceStationList_r16 rhs = (ReferenceStationList_r16) obj;
      GNSS_ReferenceStationID_r15[] rhsElements = rhs.elements;
    ...
    */
   public GNSS_ReferenceStationID_r15[] getElements () {
      return elements;
   }
   public void setElements (GNSS_ReferenceStationID_r15[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNSS_ReferenceStationID_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNSS_ReferenceStationID_r15();
