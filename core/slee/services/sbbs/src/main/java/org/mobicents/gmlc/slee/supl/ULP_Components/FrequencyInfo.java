...
public class FrequencyInfo extends Asn1Seq {
   ...
   protected FrequencyInfo_modeSpecificInfo modeSpecificInfo;
    ...
    */
   public FrequencyInfo (
      FrequencyInfo_modeSpecificInfo modeSpecificInfo_
   ) {
      super();
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof FrequencyInfo) ) return false;

      FrequencyInfo rhs = (FrequencyInfo) obj;
    ...
    */
   public FrequencyInfo_modeSpecificInfo getModeSpecificInfo () {
      return modeSpecificInfo;
   }

   public void setModeSpecificInfo (FrequencyInfo_modeSpecificInfo value) {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return modeSpecificInfo;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      modeSpecificInfo = new FrequencyInfo_modeSpecificInfo();
