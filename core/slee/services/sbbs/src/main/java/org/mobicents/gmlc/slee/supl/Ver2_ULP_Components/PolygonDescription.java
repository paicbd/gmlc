...
public class PolygonDescription extends Asn1SeqOf {
    ...
    * populated.
    */
   public PolygonDescription (int numRecords) {
      elements = new Coordinate [numRecords];
   }
    ...
    * given the array.  
    */
   public PolygonDescription (Coordinate[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof PolygonDescription) ) return false;
      PolygonDescription rhs = (PolygonDescription) obj;
      Coordinate[] rhsElements = rhs.elements;
   ...
   public void setElements (Coordinate[] value) {
      elements = value;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (3, 15);
      int numElements = (int) buffer.decodeLength();

      elements = new Coordinate [numElements];
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 3, 15);
