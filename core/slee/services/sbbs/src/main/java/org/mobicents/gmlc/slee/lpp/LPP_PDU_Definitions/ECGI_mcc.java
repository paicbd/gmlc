...
public class ECGI_mcc extends Asn1SeqOf {
    ...
    * populated.
    */
   public ECGI_mcc (int numRecords) {
    ...
    * given the array.  
    */
   public ECGI_mcc (Asn1Integer[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ECGI_mcc) ) return false;
      ECGI_mcc rhs = (ECGI_mcc) obj;
