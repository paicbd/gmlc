  ...
  <slia ver="3.4.0">
    ...
    <extension_params>
            <msids>
                ...
                <msid type="IMEI">011714004661050</msid>
            </msids>
            <tai>
                <mcc>748</mcc>
                <mnc>1</mnc>
...
<svc_result ver="3.4.0">
  <slia ver="3.4.0">
    <pos pos_method="Conventional Modernized GPS" result_type="FINAL">
    ...
    <extension_params>
        <msids>
            <msid type="MSISDN">61909077937</msid>
            <msid type="IMSI">505036871012345</msid>
        </msids>
    </extension_params>
  </slia>
</svc_result>
...
<svc_result ver="3.4.0">
  <tlrep ver="3.4.0">
    <pos pos_method="OTDOA" result_type="FINAL">
    ...
    <extension_params>
        <msids>
            <msid type="MSISDN">60192235906</msid>
            <msid type="IMSI">502196871012345</msid>
        </msids>
        <velocity_estimate>
            <horizontal_speed>101</horizontal_speed>
            <bearing>2</bearing>
            <vertical_speed>7</vertical_speed>
            <uncertainty_horizontal_speed>3</uncertainty_horizontal_speed>
            <uncertainty_vertical_speed>1</uncertainty_vertical_speed>
            <velocity_type>HorizontalWithVerticalVelocityAndUncertainty</velocity_type>
        </velocity_estimate>
    </extension_params>
  </tlrep>
</svc_result>
...
<svc_result ver="3.4.0">
	<slrep ver="3.4.0">
        ...
        <extension_params>
            <msids>
                <msid type="MSISDN">59898828111</msid>
                <msid type="IMSI">748017654390127</msid>
            </msids>
            <serving_node>
                <diameter_identity>
                    <sgsn_name>sgsn1B34.mnc01.mcc748.gprs</sgsn_name>
                    <sgsn_realm>emnc02.mcc748.gprs</sgsn_realm>
                </diameter_identity>
                <sgsnid>
                    <sgsnno>59899180071</sgsnno>
                </sgsnid>
            </serving_node>
        </extension_params>
	</slrep>
...
<?xml version="1.0" encoding="UTF-8"?><svc_result ver="3.4.0">
    <slia ver="3.4.0">
        <pos pos_method="UE-Assisted GPS" result_type="FINAL">
            <msid type="MSISDN">573195897484</msid>
            <pd>
                <time utc_off="-0300">20260429152638</time>
                <shape>
                    <EllipticalArea>
                        <coord>
                            <X>6.195592</X>
                ...
                <civicloc>
                    <civicloc_element element_type="COUNTRY">CO</civicloc_element>
                    <civicloc_element element_type="A1">Antioquia</civicloc_element>
                    <civicloc_element element_type="A3">Medellín</civicloc_element>
                    <civicloc_element element_type="A6">Calle 2 Sur</civicloc_element>
                    <civicloc_element element_type="HNO">20-185</civicloc_element>
                    <civicloc_element element_type="PC">050022</civicloc_element>
                </civicloc>
                <alt>200</alt>
                <alt_unc>0</alt_unc>
            </pd>
        ...
        <extension_params>
            <msids>
                <msid type="MSISDN">573195897484</msid>
                <msid type="IMSI">732101509580853</msid>
            </msids>
            <velocity_estimate>
                <horizontal_speed>20</horizontal_speed>
                <bearing>0</bearing>
                <vertical_speed>0</vertical_speed>
                <uncertainty_horizontal_speed>0</uncertainty_horizontal_speed>
            ...
            <serving_node>
                <diameter_identity>
                    <mme_name>mmec10.mmegi7002.mme.epc.mnc010.mcc732.3gppnetwork.org</mme_name>
                    <mme_realm>epc.mnc010.mcc732.3gppnetwork.org</mme_realm>
                </diameter_identity>
            </serving_node>
        </extension_params>
    </slia>
	...
	<tlrep ver="3.4.0">
		...
		<extension_params>
            <msids>
                <msid type="MSISDN">573195897484</msid>
                <msid type="IMSI">732101509580853</msid>
                <msid type="IMEI">352154090165449</msid>
            </msids>
            <pos pos_method="OTDOA" result_type="FINAL">
                <msid type="MSISDN">59899077938</msid>
                <pd>
                    <time utc_off="-0300">20260429153641</time>
                    <shape>
                        <EllipticalArea>
						    <coord>
							    <X>6.195593</X>
                    ...
                    <alt>200</alt>
                    <alt_unc>11.198834</alt_unc>
                </pd>
            </pos>
            <velocity_estimate>
                <horizontal_speed>104</horizontal_speed>
                <bearing>0</bearing>
                <vertical_speed>0</vertical_speed>
                <uncertainty_horizontal_speed>0</uncertainty_horizontal_speed>
                <uncertainty_vertical_speed>0</uncertainty_vertical_speed>
...
including the previous plus the reported location id (in this case, the serving cell and tracking area parameters)
[source,xml]
----
<?xml version="1.0" encoding="UTF-8"?><svc_result ver="3.4.0">
	<tlra ver="3.4.0">
        ...
        <extension_params>
            <msids>
                <msid type="MSISDN">573195897484</msid>
                <msid type="IMSI">732026871012345</msid>
            </msids>
            <ecgi>
                <mcc>748</mcc>
                <mnc>1</mnc>
